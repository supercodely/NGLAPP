...
function TaskPreApprovalBlock(ctx) {
  const { tasksPendingPreApproval, approveTaskPre, rejectTaskPre, deptColor, personLabel, t, inputStyle, entryCommentDraft, setEntryCommentDraft, runWithBusy, busyAction } = ctx;
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "flex flex-col gap-2.5 mb-4", children: [
    ...
    tasksPendingPreApproval.map((tk) => {
...
import { ArrowLeftRight as ArrowLeftRight2, Check as Check3, X as X11 } from "lucide-react";
...
function TaskManager() {
  ...
  const viewerOnDuty = useMemo(() => isWithinDutyHours(viewer, OPERATOR_ROLES), [viewer, clockTick]);
  ...
  return /* @__PURE__ */ jsxs15("div", { dir: lang === "en" ? "ltr" : "rtl", className: "min-h-screen w-full", style: { background: "#EEF1F4", fontFamily: lang === "en" ? "system-ui, sans-serif" : "'Tajawal', sans-serif" }, children: [
    ...
    /* @__PURE__ */ jsxs15("div", { className: "max-w-3xl mx-auto px-4 py-6", children: [
      ...
      viewerRole === "admin" ? /* @__PURE__ */ jsxs15(Fragment7, { children: [
        ...
        !activeOverlay && /* @__PURE__ */ jsxs15(Fragment7, { children: [
          ...
          mainSubTab === "tasks" && /* @__PURE__ */ jsxs15(Fragment7, { children: [
            AlertsBlock(ctx),
