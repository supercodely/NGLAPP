...
// src/components/ReviewBlock.jsx
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "mt-2 pt-2 flex flex-col gap-2", style: { borderTop: "1px solid #EEF1F4" }, children: [
    ...
    myTurn && /* @__PURE__ */ jsxs2("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx2("button", { onClick: () => runWithBusy("approve_" + item.id, () => {
        ...
        clearDraft();
      }), className: "flex-1 flex items-center justify-center gap-1.5 text-xs font-bold py-2 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: busyAction === "approve_" + item.id ? BtnContent2(ctx, "approve_" + item.id, isShiftTurn(status) ? t("approve") : isNightPendingConfirmation(status) ? t("confirmNightBtn") : t("approveFinal")) : /* @__PURE__ */ jsxs2(Fragment, { children: [
      ...
      /* @__PURE__ */ jsx2("button", { onClick: () => runWithBusy("reroute_" + item.id, () => {
        ...
        clearDraft();
      }), className: "flex-1 text-xs font-bold py-2 rounded-lg", style: { background: "#C0392B", color: "white" }, children: BtnContent2(ctx, "reroute_" + item.id, isNightPendingConfirmation(status) ? t("rejectNightBtn") : t("reroute")) })
    ] }),
...
// src/components/ProblemComponents.jsx
...
// src/components/StaffOverlay.jsx
...
function StaffOverlay(ctx) {
  ...
  let shiftFiltered = staffTab === "present" ? filtered.filter((p) => (p.shift || "day") === presentShiftTab) : filtered;
            ...
            /* @__PURE__ */ jsxs7("div", { className: "flex flex-col items-end gap-1.5 shrink-0", children: [
              canManage && (() => {
                ...
                return /* @__PURE__ */ jsxs7(Fragment4, { children: [
                  ...
                  !p.onLeave && /* @__PURE__ */ jsx7("button", { onClick: () => askStaffAction(p, "shift"), className: "flex items-center gap-1.5 text-[11px] font-bold px-3 py-1.5 rounded-lg", style: { background: "#F4F6F8", color: "#5B6B79", border: "1px solid #E2E8ED" }, children: lang === "ar" ? /* @__PURE__ */ jsxs7(Fragment4, { children: [
                    /* @__PURE__ */ jsx7(DirArrow, { size: 12 }),
                    " ",
...
// src/components/LogbookOverlay.jsx
  ...
  function SummaryBlock({ dept }) {
    ...
    return /* @__PURE__ */ jsxs8("div", { className: "rounded-xl p-4 flex flex-col gap-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      ...
      /* @__PURE__ */ jsxs8("div", { className: "flex gap-2", children: [
        ...
        viewer.inCharge && viewerOnDuty && /* @__PURE__ */ jsx8("button", { onClick: () => runWithBusy("approveLogbook_" + dept, () => approveLogbook(dept)), className: "flex-1 text-xs font-bold py-2 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: BtnContent2(ctx, "approveLogbook_" + dept, t("approveLogbookBtn")) })
      ] }),
...
// src/components/ReadingsOverlay.jsx
...
// src/components/ReportsOverlay.jsx
...
// src/components/HandoverBlock.jsx
...
function AutoHandoverBanner(ctx) {
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-3.5 mb-4", style: { background: "#FFF6EB", border: "1px solid #F0C57A" }, children: [
    ...
    canAct && /* @__PURE__ */ jsxs14(Fragment7, { children: [
...
function TaskManager() {
  ...
  const [autoHandover, setAutoHandover] = useState(null);
  ...
  const dutyMinutesLeft = useMemo(() => {
    ...
    const OFFICE_ROLES2 = ["Coordinator", "Section Supervisor", "Unit Supervisor"];
    let endHour;
    if (OFFICE_ROLES2.includes(viewer.role)) endHour = 19;
  ...
  function submitTask(e) {
    ...
    if (editingId) {
      setTasks((prev) => prev.map((tk) => {
        ...
        return { ...tk, ...taskForm, privateTo: taskForm.type === "private" ? taskForm.privateTo : null, reviewStatus: nextReviewStatus, comments };
      }));
      ...
      const entryStatus = computeTaskEntryStatus(viewer.role, isNightGapWindow());
      setTasks((prev) => [{ id: getNextTaskId(), ...taskForm, privateTo: taskForm.type === "private" ? taskForm.privateTo : null, createdBy: currentUserId, createdAt: nowStamp(lang), status: "not_started", completedAt: null, reviewStatus: entryStatus, comments: [] }, ...prev]);
    }
  ...
  function setStatus(id, status) {
    setTasks((prev) => prev.map((tk) => {
      ...
      return { ...tk, status, completedAt: status === "completed" ? today : null, reviewStatus: nextReviewStatus };
    }));
  ...
  useEffect(() => {
    ...
    const key = info ? today + "_" + info.label : null;
    if (info && (!autoHandover || autoHandover.key !== key)) {
      ...
      if (outgoing && incoming && outgoing.id !== incoming.id) {
        setAutoHandover({ key, boundary: info.label, boundaryHour: info.boundaryHour, outgoingId: outgoing.id, incomingId: incoming.id, tempAssigneeId: null, phase: "notified", extendUntil: null, extendMinutes: null });
      }
  ...
  return /* @__PURE__ */ jsxs15("div", { dir: lang === "en" ? "ltr" : "rtl", className: "min-h-screen w-full", style: { background: "#EEF1F4", fontFamily: lang === "en" ? "system-ui, sans-serif" : "'Tajawal', sans-serif" }, children: [
    ...
    /* @__PURE__ */ jsxs15("div", { className: "max-w-3xl mx-auto px-4 py-6", children: [
      ...
      viewerRole === "admin" ? /* @__PURE__ */ jsxs15(Fragment8, { children: [
        ...
        !activeOverlay && /* @__PURE__ */ jsxs15(Fragment8, { children: [
          ...
          mainSubTab === "problems" && /* @__PURE__ */ jsxs15("div", { className: "flex items-center gap-2 mb-2", children: [
            ...
            /* @__PURE__ */ jsx15("button", { onClick: () => setProblemSearchOpen((o) => !o), className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", style: { background: problemSearchOpen ? "#1F4E79" : "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx15(Search3, { size: 18, color: problemSearchOpen ? "white" : "#16222E" }) }),
          ...
          mainSubTab === "tasks" && /* @__PURE__ */ jsxs15(Fragment8, { children: [
            AlertsBlock(ctx),
