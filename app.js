...
var DEFAULT_MENU_PERMISSIONS = {
  ...
  "Panel Operator": ["tasks", "issues", "calendar", "logbook", "readings", "staff", "eventList"],
...
var STR = {
  ...
  readNotifsLbl: { ar: "\u0645\u0642\u0631\u0648\u0621\u0629", en: "Read" },
  ...
  addReportTab: { ar: "\u0625\u0636\u0627\u0641\u0629 \u062C\u062F\u064A\u062F", en: "Add New" },
  ...
  saveReportBtn: { ar: "\u062D\u0641\u0638 \u0627\u0644\u062A\u0642\u0631\u064A\u0631", en: "Save Report" },
  ...
  reportsLockedForPanelNote: { ar: "\u0642\u0633\u0645 \u0627\u0644\u062A\u0642\u0627\u0631\u064A\u0631 \u0645\u062E\u0641\u064A \u0628\u0634\u0643\u0644 \u062F\u0627\u0626\u0645 \u0639\u0646 \u0645\u0634\u063A\u0651\u0644 \u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645", en: "Reports is permanently hidden for the Control Panel Operator" },
...
function ReportsOverlay(ctx) {
  ...
  const canSubmitProduction = viewer.role === "Shift Supervisor";
  const isFieldOperator = viewerRole === "operator" && !canManage && viewer.role !== "Panel Operator";
  const effectiveReportsTab = isFieldOperator ? "periodic" : reportsTab;
  const effectivePeriodicSection = isFieldOperator ? viewer.department : periodicSection;
  const periodicKind = effectivePeriodicSection === "General" ? "general_" + periodicPeriod : effectivePeriodicSection + "_" + periodicPeriod;
  const canSubmitPeriodic = effectivePeriodicSection === "General" ? isShiftSupervisor : viewer.department === effectivePeriodicSection && (viewerRole === "operator" || canManage);
  ...
  const labDayReports = labReportsLog.filter((r) => r.dateISO === labViewDate && r.unit === labUnitTab);
  function DateNav({ date, setDate, searchOpen, setSearchOpen }) {
    return /* @__PURE__ */ jsxs10(Fragment7, { children: [
      /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx10("button", { onClick: () => setSearchOpen(!searchOpen), className: "w-9 h-9 rounded-lg flex items-center justify-center shrink-0", style: { background: searchOpen ? "#1F4E79" : "#FFFFFF", border: "1px solid " + (searchOpen ? "#1F4E79" : "#DCE3E8") }, children: /* @__PURE__ */ jsx10(Search4, { size: 15, color: searchOpen ? "white" : "#16222E" }) }),
        /* @__PURE__ */ jsxs10("div", { className: "flex-1 flex items-center justify-between rounded-xl p-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
          /* @__PURE__ */ jsx10("button", { onClick: () => setDate((d) => shiftISODate(d, -1)), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx10(ChevronUp4, { size: 16, style: { transform: "rotate(-90deg)" }, color: "#16222E" }) }),
          /* @__PURE__ */ jsx10("p", { className: "text-sm font-black", style: { color: "#16222E" }, children: date === today2 ? t("todayLbl") : date }),
          /* @__PURE__ */ jsx10("button", { onClick: () => setDate((d) => shiftISODate(d, 1)), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx10(ChevronUp4, { size: 16, style: { transform: "rotate(90deg)" }, color: "#16222E" }) })
        ] })
      ] }),
      searchOpen && /* @__PURE__ */ jsx10("div", { className: "rounded-xl p-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx10("input", { type: "date", value: date, onChange: (e) => {
  ...
  function ReportCard(r) {
    return /* @__PURE__ */ jsxs10("div", { className: "rounded-xl p-3.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
  ...
  function UploadForm(onSave, canSubmit, restrictionNote) {
    if (!canSubmit) return /* @__PURE__ */ jsx10("p", { className: "text-xs text-center py-6", style: { color: "#8A97A3" }, children: restrictionNote });
    return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-3", children: [
      !reportAttachment ? /* @__PURE__ */ jsxs10("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxs10("label", { className: "flex-1 flex items-center justify-center gap-1.5 text-sm font-bold py-3 rounded-lg cursor-pointer", style: { background: "#F4F6F8", color: "#16222E", border: "1px dashed #DCE3E8" }, children: [
          ...
          " ",
          t("uploadFileBtn"),
          /* @__PURE__ */ jsx10("input", { type: "file", accept: "image/*,.pdf", multiple: true, className: "hidden", onChange: handleReportFile })
        ] })
      ...
      /* @__PURE__ */ jsx10("button", { onClick: () => runWithBusy("saveReport", () => onSave()), disabled: !reportAttachment, className: "text-sm font-bold py-2.5 rounded-lg", style: { background: "#1F4E79", color: "white", opacity: !reportAttachment ? 0.5 : 1 }, children: BtnContent(ctx, "saveReport", t("saveReportBtn")) })
    ] });
  }
  if (viewer.role === "Panel Operator") {
    return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-3", style: { animation: "fadeSlideUp 240ms ease-out" }, children: [
      ...
      /* @__PURE__ */ jsx10("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: t("noEntryPermission") })
    ] });
  }
  return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-3", style: { animation: "fadeSlideUp 240ms ease-out" }, children: [
    /* @__PURE__ */ jsxs10("div", { className: "flex items-center justify-between mb-1", children: [
    ...
    !isFieldOperator && /* @__PURE__ */ jsxs10("div", { className: "flex gap-2 mb-1", children: [
    ...
    effectiveReportsTab === "daily" && /* @__PURE__ */ jsxs10(Fragment7, { children: [
      /* @__PURE__ */ jsxs10("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsx10("button", { onClick: () => setDailySection("production"), className: "flex-1 text-xs font-bold py-2 rounded-lg", style: { background: dailySection === "production" ? "#B25E09" : "#F4F6F8", color: dailySection === "production" ? "white" : "#5B6B79" }, children: t("dailyProductionReport") }),
        /* @__PURE__ */ jsx10("button", { onClick: () => setDailySection("lab"), className: "flex-1 text-xs font-bold py-2 rounded-lg", style: { background: dailySection === "lab" ? "#B25E09" : "#F4F6F8", color: dailySection === "lab" ? "white" : "#5B6B79" }, children: t("labReportTitle") })
      ] }),
      dailySection === "production" && /* @__PURE__ */ jsxs10(Fragment7, { children: [
        /* @__PURE__ */ jsxs10("div", { className: "flex gap-2 mb-1", children: [
          /* @__PURE__ */ jsx10("button", { onClick: () => setReportsSubTab("history"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: reportsSubTab === "history" ? "#1F4E79" : "#FFFFFF", color: reportsSubTab === "history" ? "white" : "#5B6B79", border: "1px solid " + (reportsSubTab === "history" ? "#1F4E79" : "#DCE3E8") }, children: t("readingsHistoryTab") }),
          canSubmitProduction && /* @__PURE__ */ jsx10("button", { onClick: () => setReportsSubTab("add"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: reportsSubTab === "add" ? "#1F4E79" : "#FFFFFF", color: reportsSubTab === "add" ? "white" : "#5B6B79", border: "1px solid " + (reportsSubTab === "add" ? "#1F4E79" : "#DCE3E8") }, children: t("addReportTab") })
        ] }),
        (reportsSubTab === "history" || !canSubmitProduction) && /* @__PURE__ */ jsxs10(Fragment7, { children: [
          /* @__PURE__ */ jsx10(DateNav, { date: reportsViewDate, setDate: setReportsViewDate, searchOpen: reportsDateSearchOpen, setSearchOpen: setReportsDateSearchOpen }),
          /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-2.5", children: [
            ...
            dayReports.map(ReportCard)
          ] })
        ] }),
        reportsSubTab === "add" && canSubmitProduction && /* @__PURE__ */ jsx10("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: UploadForm(() => saveReport("production", "daily"), canSubmitProduction, t("panelOperatorOnlyNote")) })
      ] }),
      dailySection === "lab" && /* @__PURE__ */ jsxs10(Fragment7, { children: [
        /* @__PURE__ */ jsx10("div", { className: "flex flex-wrap gap-2", children: LAB_UNITS.map((u) => /* @__PURE__ */ jsx10("button", { onClick: () => setLabUnitTab(u), className: "text-xs font-bold px-3 py-2 rounded-lg", style: { background: labUnitTab === u ? "#1F4E79" : "#FFFFFF", color: labUnitTab === u ? "white" : "#5B6B79", border: "1px solid " + (labUnitTab === u ? "#1F4E79" : "#DCE3E8") }, children: u }, u)) }),
        /* @__PURE__ */ jsx10(DateNav, { date: labViewDate, setDate: setLabViewDate, searchOpen: labDateSearchOpen, setSearchOpen: setLabDateSearchOpen }),
        /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-2.5", children: [
          labDayReports.length === 0 && /* @__PURE__ */ jsx10("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: t("noReportsYet") }),
          labDayReports.map((r) => /* @__PURE__ */ jsx10("div", { className: "rounded-xl p-3.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-3", children: [
            r.attachment?.isImage ? /* @__PURE__ */ jsx10("img", { src: r.attachment.dataUrl, alt: "", className: "w-12 h-12 rounded-lg object-cover shrink-0" }) : /* @__PURE__ */ jsx10("div", { className: "w-12 h-12 rounded-lg flex items-center justify-center shrink-0", style: { background: "#E6EEF5" }, children: /* @__PURE__ */ jsx10(FileText4, { size: 18, color: "#1F4E79" }) }),
            /* @__PURE__ */ jsxs10("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsx10("p", { className: "text-sm font-bold truncate", style: { color: "#16222E" }, children: r.attachment?.name }),
              /* @__PURE__ */ jsxs10("p", { className: "text-[11px]", style: { color: "#8A97A3" }, children: [
    ...
    effectiveReportsTab === "periodic" && /* @__PURE__ */ jsxs10(Fragment7, { children: [
      ...
      /* @__PURE__ */ jsxs10("div", { className: "flex gap-2 mb-1", children: [
        /* @__PURE__ */ jsx10("button", { onClick: () => setReportsSubTab("history"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: reportsSubTab === "history" ? "#1F4E79" : "#FFFFFF", color: reportsSubTab === "history" ? "white" : "#5B6B79", border: "1px solid " + (reportsSubTab === "history" ? "#1F4E79" : "#DCE3E8") }, children: t("readingsHistoryTab") }),
        canSubmitPeriodic && /* @__PURE__ */ jsx10("button", { onClick: () => setReportsSubTab("add"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: reportsSubTab === "add" ? "#1F4E79" : "#FFFFFF", color: reportsSubTab === "add" ? "white" : "#5B6B79", border: "1px solid " + (reportsSubTab === "add" ? "#1F4E79" : "#DCE3E8") }, children: t("addReportTab") })
      ] }),
      (reportsSubTab === "history" || !canSubmitPeriodic) && /* @__PURE__ */ jsxs10(Fragment7, { children: [
        /* @__PURE__ */ jsxs10("div", { className: "flex items-center justify-between rounded-xl p-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
          ...
          /* @__PURE__ */ jsx10("p", { className: "text-sm font-black", style: { color: "#16222E" }, children: periodicPeriod === "weekly" ? weekLabel(periodicWeekKey, lang) : monthLabel(periodicMonthKey, lang) }),
          /* @__PURE__ */ jsx10("button", { onClick: () => periodicPeriod === "weekly" ? setPeriodicWeekKey((k) => shiftWeekKey(k, 1)) : setPeriodicMonthKey((k) => shiftMonthKey(k, 1)), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx10(ChevronUp4, { size: 16, style: { transform: "rotate(90deg)" }, color: "#16222E" }) })
        ] }),
        /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-2.5", children: [
          ...
          periodicList.map(ReportCard)
        ] })
      ] }),
      reportsSubTab === "add" && canSubmitPeriodic && /* @__PURE__ */ jsxs10("div", { className: "rounded-xl p-4 flex flex-col gap-3", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
        /* @__PURE__ */ jsx10("h3", { className: "text-sm font-bold", style: { color: "#16222E" }, children: effectivePeriodicSection === "General" ? t("generalReportTitle") : t("sectionReportLabel") + " \xB7 " + effectivePeriodicSection }),
        effectivePeriodicSection === "General" && /* @__PURE__ */ jsx10("p", { className: "text-xs", style: { color: "#8A97A3" }, children: t("generalReportDesc") }),
        UploadForm(() => saveReport(periodicKind, periodicPeriod), canSubmitPeriodic, t("noEntryPermission"))
      ] })
    ] })
  ] });
}

// source/components/NotificationsOverlay.jsx
import { X as X9, Bell } from "lucide-react";
import { jsx as jsx11, jsxs as jsxs11 } from "react/jsx-runtime";
function NotificationsOverlay(ctx) {
  const { notifications, goToNotification, setActiveOverlay, t } = ctx;
  const unread = notifications.filter((n) => !n.read);
  const read = notifications.filter((n) => n.read);
  function Row(n) {
    return /* @__PURE__ */ jsxs11("button", { onClick: () => goToNotification(n), className: "w-full text-right flex items-center gap-3 rounded-xl p-3.5", style: { background: n.read ? "#F4F6F8" : "#FFFFFF", border: "1px solid " + (n.read ? "#E2E8ED" : "#DCE3E8"), opacity: n.read ? 0.65 : 1 }, children: [
      !n.read && /* @__PURE__ */ jsx11("span", { className: "w-2 h-2 rounded-full shrink-0", style: { background: "#C0392B" } }),
      /* @__PURE__ */ jsx11("span", { className: "text-xs font-black px-1.5 py-0.5 rounded shrink-0", style: { background: "#E9EEF5", color: "#1F4E79" }, children: n.kind }),
      /* @__PURE__ */ jsx11("span", { className: "text-sm flex-1 truncate", style: { color: "#16222E", fontWeight: n.read ? 500 : 700 }, children: n.text })
    ] }, n.id);
  }
  return /* @__PURE__ */ jsxs11("div", { className: "fixed inset-0 z-40 flex flex-col", style: { background: "#EEF1F4" }, children: [
    /* @__PURE__ */ jsxs11("div", { className: "flex items-center justify-between p-4 shrink-0", style: { background: "#FFFFFF", borderBottom: "1px solid #DCE3E8" }, children: [
      /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx11(Bell, { size: 20, color: "#16222E" }),
        /* @__PURE__ */ jsx11("h2", { className: "text-lg font-black", style: { color: "#16222E" }, children: t("notificationsTitle") })
      ] }),
      /* @__PURE__ */ jsx11("button", { onClick: () => setActiveOverlay(null), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx11(X9, { size: 16, color: "#16222E" }) })
    ] }),
    /* @__PURE__ */ jsxs11("div", { className: "flex-1 overflow-y-auto p-4 flex flex-col gap-2", children: [
      notifications.length === 0 && /* @__PURE__ */ jsx11("p", { className: "text-sm text-center py-10", style: { color: "#8A97A3" }, children: t("noNotifications") }),
      unread.length > 0 && /* @__PURE__ */ jsx11("div", { className: "flex flex-col gap-2 mb-2", children: unread.map(Row) }),
      read.length > 0 && /* @__PURE__ */ jsxs11("div", { className: "flex flex-col gap-2", children: [
        unread.length > 0 && /* @__PURE__ */ jsx11("p", { className: "text-xs font-bold px-1 mt-2", style: { color: "#8A97A3" }, children: t("readNotifsLbl") }),
        read.map(Row)
      ] })
    ] })
  ] });
...
import { X as X10, Languages } from "lucide-react";
...
function DrawerMenu(ctx) {
  ...
  const allowed = (menuPermissions[viewer.role] || []).filter((k) => !(viewer.role === "Panel Operator" && k === "reports"));
  const items = MENU_ITEM_DEFS.filter((it) => allowed.includes(it.key));
  return /* @__PURE__ */ jsx12("div", { className: "fixed inset-0 z-50", style: { background: "rgba(22,34,46,0.45)", opacity: drawerVisible ? 1 : 0, transition: "opacity 220ms ease" }, onClick: () => setDrawerOpen(false), children: /* @__PURE__ */ jsxs12("div", { className: "fixed top-0 w-80 h-full flex flex-col p-5 gap-1.5", style: { right: 0, background: "#FFFFFF", boxShadow: "-6px 0 24px rgba(0,0,0,0.12)", transform: drawerVisible ? "translateX(0)" : "translateX(100%)", transition: "transform 260ms cubic-bezier(0.22, 1, 0.36, 1)" }, onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs12("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsx12("h2", { className: "text-lg font-black", style: { color: "#16222E" }, children: t("menu") }),
      /* @__PURE__ */ jsx12("button", { onClick: () => setDrawerOpen(false), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx12(X10, { size: 19, color: "#5B6B79" }) })
    ] }),
    /* @__PURE__ */ jsxs12("div", { className: "flex flex-col gap-1.5 overflow-y-auto", children: [
      items.map((it, idx) => /* @__PURE__ */ jsxs12("button", { onClick: () => {
        actionByKey[it.key]();
        setDrawerOpen(false);
        ...
        /* @__PURE__ */ jsx12(it.icon, { size: 21, color: "#1F4E79" }),
        " ",
        t(it.labelKey)
      ] }, it.key)),
      items.length === 0 && /* @__PURE__ */ jsx12("p", { className: "text-sm text-center py-6", style: { color: "#8A97A3" }, children: "\u2014" })
    ] }),
    /* @__PURE__ */ jsx12("div", { className: "mt-auto pt-4", style: { borderTop: "1px solid #EEF1F4" }, children: /* @__PURE__ */ jsxs12("button", { onClick: () => setLang(lang === "ar" ? "en" : "ar"), className: "w-full flex items-center gap-3.5 text-base font-bold px-4 py-4 rounded-xl", style: { color: "#16222E", background: "#F8F9FA" }, children: [
      /* @__PURE__ */ jsx12(Languages, { size: 21, color: "#1F4E79" }),
      " ",
...
function ToastStack(ctx) {
  ...
  return /* @__PURE__ */ jsx13("div", { className: "fixed top-4 left-1/2 z-[70] flex flex-col gap-2 items-center", style: { transform: "translateX(-50%)", width: "min(92vw, 380px)" }, children: toasts.map((tt) => /* @__PURE__ */ jsxs13("div", { className: "w-full flex items-center gap-2.5 px-4 py-3 rounded-xl shadow-lg", style: { background: tt.kind === "success" ? "#1F4E3A" : tt.kind === "info" ? "#16222E" : "#7A2E22", color: "white", animation: "toastIn 240ms cubic-bezier(0.22, 1, 0.36, 1)" }, children: [
    tt.kind === "success" ? /* @__PURE__ */ jsx13(CheckCircle23, { size: 18, color: "#7EDCA8" }) : /* @__PURE__ */ jsx13(MessageSquare, { size: 18, color: "#9FB4C7" }),
    /* @__PURE__ */ jsx13("p", { className: "text-sm font-bold flex-1", children: tt.text })
  ] }, tt.id)) });
}

// source/components/AdminView.jsx
import { Trash2 as Trash22, UserPlus, ShieldCheck as ShieldCheck2, X as X11, Menu } from "lucide-react";
...
function AdminView(ctx) {
  ...
  return /* @__PURE__ */ jsxs14("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsx14(ShieldCheck2, { size: 16, color: "#1F4E79" }),
        /* @__PURE__ */ jsx14("h3", { className: "text-sm font-bold", style: { color: "#16222E" }, children: t("accounts") })
      ] }),
      /* @__PURE__ */ jsxs14("form", { onSubmit: addPerson, className: "flex flex-col sm:flex-row gap-2 items-end mb-3", children: [
        /* @__PURE__ */ jsx14("input", { value: newPerson.name, onChange: (e) => setNewPerson({ ...newPerson, name: e.target.value }), placeholder: t("name"), className: "flex-1 text-sm outline-none", style: inputStyle }),
        /* @__PURE__ */ jsx14("select", { value: newPerson.department, onChange: (e) => setNewPerson({ ...newPerson, department: e.target.value }), className: "text-sm outline-none", style: inputStyle, children: departments.map((d) => /* @__PURE__ */ jsx14("option", { children: d }, d)) }),
        /* @__PURE__ */ jsx14("select", { value: newPerson.role, onChange: (e) => setNewPerson({ ...newPerson, role: e.target.value }), className: "text-sm outline-none", style: inputStyle, children: roles.map((r) => /* @__PURE__ */ jsx14("option", { children: r }, r)) }),
        /* @__PURE__ */ jsxs14("label", { className: "flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-lg", style: { background: "#F4F6F8", color: "#5B6B79" }, children: [
          /* @__PURE__ */ jsx14("input", { type: "checkbox", checked: newPerson.isAdmin, onChange: (e) => setNewPerson({ ...newPerson, isAdmin: e.target.checked }) }),
          " ",
          t("appAdmin")
        ] }),
        /* @__PURE__ */ jsxs14("button", { type: "submit", className: "flex items-center gap-1.5 text-sm font-bold px-4 py-2 rounded-lg shrink-0", style: { background: "#1F4E79", color: "white" }, children: [
          /* @__PURE__ */ jsx14(UserPlus, { size: 15 }),
          " ",
          t("addBtn")
        ] })
      ] }),
      /* @__PURE__ */ jsx14("div", { className: "flex flex-col gap-2 max-h-96 overflow-y-auto", children: people.map((p) => /* @__PURE__ */ jsxs14("div", { className: "flex items-center justify-between rounded-lg px-3 py-2", style: { background: "#F4F6F8" }, children: [
        /* @__PURE__ */ jsxs14("div", { children: [
          /* @__PURE__ */ jsx14("span", { className: "text-sm font-bold", style: { color: "#16222E" }, children: p.name }),
          /* @__PURE__ */ jsx14("span", { className: "text-xs mr-2", style: { color: "#8A97A3" }, children: p.employeeId }),
          /* @__PURE__ */ jsxs14("span", { className: "text-xs mr-2", style: labelStyle, children: [
            p.role,
            " \xB7 ",
            p.department
          ] }),
          p.isAdmin && /* @__PURE__ */ jsx14("span", { className: "text-[10px] font-bold mr-2 px-2 py-0.5 rounded-full", style: { background: "#E6EEF5", color: "#1F4E79" }, children: t("appAdmin") })
        ] }),
        /* @__PURE__ */ jsx14("button", { onClick: () => removePerson(p.id), className: "w-7 h-7 rounded-md flex items-center justify-center", style: { color: "#C0392B" }, children: /* @__PURE__ */ jsx14(Trash22, { size: 14 }) })
      ] }, p.id)) })
    ] }),
    /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      /* @__PURE__ */ jsx14("h3", { className: "text-sm font-bold mb-3", style: { color: "#16222E" }, children: t("departmentsLabel") }),
      /* @__PURE__ */ jsxs14("form", { onSubmit: addDept, className: "flex gap-2 mb-3", children: [
        /* @__PURE__ */ jsx14("input", { value: newDept, onChange: (e) => setNewDept(e.target.value), placeholder: t("newDeptPH"), className: "flex-1 text-sm outline-none", style: inputStyle }),
        /* @__PURE__ */ jsx14("button", { type: "submit", className: "text-sm font-bold px-4 rounded-lg", style: { background: "#1F4E79", color: "white" }, children: t("addBtn") })
      ] }),
      /* @__PURE__ */ jsx14("div", { className: "flex flex-wrap gap-2", children: departments.map((d) => /* @__PURE__ */ jsxs14("span", { className: "flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full", style: { background: deptColor(d).bg, color: deptColor(d).text }, children: [
        d,
        /* @__PURE__ */ jsx14("button", { onClick: () => removeDept(d), children: /* @__PURE__ */ jsx14(X11, { size: 12 }) })
      ] }, d)) })
    ] }),
    /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      /* @__PURE__ */ jsx14("h3", { className: "text-sm font-bold mb-3", style: { color: "#16222E" }, children: t("rolesLabel") }),
      /* @__PURE__ */ jsxs14("form", { onSubmit: addRole, className: "flex gap-2 mb-3", children: [
        /* @__PURE__ */ jsx14("input", { value: newRole, onChange: (e) => setNewRole(e.target.value), placeholder: t("newRolePH"), className: "flex-1 text-sm outline-none", style: inputStyle }),
        /* @__PURE__ */ jsx14("button", { type: "submit", className: "text-sm font-bold px-4 rounded-lg", style: { background: "#1F4E79", color: "white" }, children: t("addBtn") })
      ] }),
      /* @__PURE__ */ jsx14("div", { className: "flex flex-wrap gap-2", children: roles.map((r) => /* @__PURE__ */ jsxs14("span", { className: "flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-full", style: { background: "#F4F6F8", color: "#5B6B79" }, children: [
        r,
        /* @__PURE__ */ jsx14("button", { onClick: () => removeRole(r), children: /* @__PURE__ */ jsx14(X11, { size: 12 }) })
      ] }, r)) })
    ] }),
    /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2 mb-1", children: [
        /* @__PURE__ */ jsx14(Menu, { size: 16, color: "#1F4E79" }),
        /* @__PURE__ */ jsx14("h3", { className: "text-sm font-bold", style: { color: "#16222E" }, children: t("menuPermissionsTitle") })
      ] }),
      /* @__PURE__ */ jsx14("p", { className: "text-xs mb-3", style: { color: "#8A97A3" }, children: t("menuPermissionsDesc") }),
      /* @__PURE__ */ jsx14("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs14("table", { className: "w-full text-xs", style: { borderCollapse: "collapse" }, children: [
        /* @__PURE__ */ jsx14("thead", { children: /* @__PURE__ */ jsxs14("tr", { children: [
          /* @__PURE__ */ jsx14("th", { className: "text-start py-2 px-2 sticky right-0", style: { background: "#FFFFFF", color: "#8A97A3" }, children: t("rolesLabel") }),
          MENU_ITEM_DEFS.map((it) => /* @__PURE__ */ jsx14("th", { className: "py-2 px-2 font-bold whitespace-nowrap", style: { color: "#16222E" }, children: t(it.labelKey) }, it.key))
        ] }) }),
        /* @__PURE__ */ jsx14("tbody", { children: [...SUPERVISOR_ROLES, ...OPERATOR_ROLES].map((role) => /* @__PURE__ */ jsxs14("tr", { style: { borderTop: "1px solid #EEF1F4" }, children: [
          /* @__PURE__ */ jsx14("td", { className: "py-2 px-2 font-bold whitespace-nowrap sticky right-0", style: { background: "#FFFFFF", color: "#16222E" }, children: role }),
          MENU_ITEM_DEFS.map((it) => {
            const locked = role === "Panel Operator" && it.key === "reports";
            return /* @__PURE__ */ jsx14("td", { className: "py-2 px-2 text-center", children: /* @__PURE__ */ jsx14("input", { type: "checkbox", checked: !locked && (menuPermissions[role] || []).includes(it.key), disabled: locked, title: locked ? t("reportsLockedForPanelNote") : void 0, onChange: () => !locked && toggleMenuPermission(role, it.key) }) }, it.key);
          })
        ] }, role)) })
      ] }) })
    ] })
...
import { ArrowLeftRight as ArrowLeftRight2, Check as Check3, X as X12, Clock, ShieldCheck as ShieldCheck3 } from "lucide-react";
...
function HandoverBanner(ctx) {
  ...
  return /* @__PURE__ */ jsx15("div", { className: "flex flex-col gap-2 mb-4", children: myIncomingHandovers.map((req) => /* @__PURE__ */ jsxs15("div", { className: "rounded-xl p-3.5", style: { background: "#FFF6EB", border: "1px solid #F0C57A" }, children: [
    /* @__PURE__ */ jsxs15("div", { className: "flex items-center gap-2 mb-2", children: [
      /* @__PURE__ */ jsx15(ArrowLeftRight2, { size: 16, color: "#B25E09" }),
      /* @__PURE__ */ jsx15("p", { className: "text-sm font-bold", style: { color: "#5B4321" }, children: t("handoverRequestTitle") })
    ] }),
    /* @__PURE__ */ jsxs15("p", { className: "text-xs mb-3", style: { color: "#5B4321" }, children: [
      /* @__PURE__ */ jsx15("span", { className: "font-bold", children: req.fromName }),
      " ",
      t("handoverRequestMsg"),
      " ",
      /* @__PURE__ */ jsx15("span", { className: "font-bold", children: req.role })
    ] }),
    /* @__PURE__ */ jsxs15("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxs15("button", { onClick: () => respondHandover(req.id, false), className: "flex-1 flex items-center justify-center gap-1.5 text-xs font-bold py-2 rounded-lg", style: { background: "#FFFFFF", border: "1px solid #DCE3E8", color: "#5B6B79" }, children: [
        /* @__PURE__ */ jsx15(X12, { size: 13 }),
        " ",
        t("handoverRejectBtn")
      ] }),
      /* @__PURE__ */ jsxs15("button", { onClick: () => respondHandover(req.id, true), className: "flex-1 flex items-center justify-center gap-1.5 text-xs font-bold py-2 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: [
        /* @__PURE__ */ jsx15(Check3, { size: 13 }),
        " ",
        t("handoverAcceptBtn")
      ] })
    ] })
...
function AutoHandoverBanner(ctx) {
  ...
  if (isOutgoing) {
    return /* @__PURE__ */ jsxs15("div", { className: "rounded-xl p-3.5 mb-4 flex items-center gap-2", style: { background: "#E9F3FB", border: "1px solid #BFE0F5" }, children: [
      /* @__PURE__ */ jsx15(Clock, { size: 16, color: "#1F4E79" }),
      /* @__PURE__ */ jsxs15("p", { className: "text-xs", style: { color: "#1F4E79" }, children: [
        t("autoHandoverTitle"),
        " \u2014 ",
  ...
  if (autoHandover.phase === "temp_delegated") {
    return /* @__PURE__ */ jsxs15("div", { className: "rounded-xl p-3.5 mb-4", style: { background: "#FFF6EB", border: "1px solid #F0C57A" }, children: [
      /* @__PURE__ */ jsx15("p", { className: "text-xs mb-2", style: { color: "#5B4321" }, children: t("tempDelegatedNotice") }),
      /* @__PURE__ */ jsx15("button", { onClick: reclaimAutoHandover, className: "text-xs font-bold px-4 py-2 rounded-lg", style: { background: "#1F4E79", color: "white" }, children: t("reclaimBtn") })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs15("div", { className: "rounded-xl p-3.5 mb-4", style: { background: "#FFF6EB", border: "1px solid #F0C57A" }, children: [
    /* @__PURE__ */ jsxs15("div", { className: "flex items-center gap-2 mb-2", children: [
      /* @__PURE__ */ jsx15(Clock, { size: 16, color: "#B25E09" }),
      /* @__PURE__ */ jsx15("p", { className: "text-sm font-bold", style: { color: "#5B4321" }, children: t("autoHandoverTitle") })
    ] }),
    /* @__PURE__ */ jsxs15("p", { className: "text-xs mb-3", style: { color: "#5B4321" }, children: [
    ...
    canAct && /* @__PURE__ */ jsxs15(Fragment8, { children: [
      /* @__PURE__ */ jsxs15("div", { className: "flex flex-wrap gap-2 mb-2", children: [
        /* @__PURE__ */ jsxs15("button", { onClick: acceptAutoHandoverNow, className: "flex items-center gap-1.5 text-xs font-bold px-3 py-2 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: [
          /* @__PURE__ */ jsx15(Check3, { size: 13 }),
          " ",
          t("acceptNowBtn")
        ] }),
        /* @__PURE__ */ jsx15("button", { onClick: () => extendAutoHandover(5), className: "text-xs font-bold px-3 py-2 rounded-lg", style: { background: "#FFFFFF", border: "1px solid #DCE3E8", color: "#5B6B79" }, children: t("extendBtn5") }),
        /* @__PURE__ */ jsx15("button", { onClick: () => extendAutoHandover(10), className: "text-xs font-bold px-3 py-2 rounded-lg", style: { background: "#FFFFFF", border: "1px solid #DCE3E8", color: "#5B6B79" }, children: t("extendBtn10") }),
        /* @__PURE__ */ jsx15("button", { onClick: () => extendAutoHandover(15), className: "text-xs font-bold px-3 py-2 rounded-lg", style: { background: "#FFFFFF", border: "1px solid #DCE3E8", color: "#5B6B79" }, children: t("extendBtn15") })
      ] }),
      colleagues.length > 0 && /* @__PURE__ */ jsxs15("div", { className: "pt-2", style: { borderTop: "1px solid #F0C57A" }, children: [
        /* @__PURE__ */ jsxs15("p", { className: "text-[11px] font-bold mb-1.5", style: { color: "#5B4321" }, children: [
          t("cantComeBtn"),
          ":"
        ] }),
        /* @__PURE__ */ jsx15("div", { className: "flex flex-wrap gap-1.5", children: colleagues.map((c) => /* @__PURE__ */ jsx15("button", { onClick: () => tempDelegateAutoHandover(c.id), className: "text-[11px] font-bold px-2.5 py-1.5 rounded-lg", style: { background: "#FBE7E4", color: "#C0392B" }, children: c.name }, c.id)) })
      ] })
    ] })
  ] });
}
function WhoInChargeModal(ctx) {
  ...
  return /* @__PURE__ */ jsx15("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", style: { background: "rgba(22,34,46,0.45)" }, onClick: () => setWhoInChargeOpen(false), children: /* @__PURE__ */ jsxs15("div", { className: "w-full max-w-sm rounded-xl p-4 max-h-[80vh] overflow-y-auto", style: { background: "#FFFFFF" }, onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs15("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsx15("h3", { className: "text-base font-black", style: { color: "#16222E" }, children: t("whoInChargeTitle") }),
      /* @__PURE__ */ jsx15("button", { onClick: () => setWhoInChargeOpen(false), children: /* @__PURE__ */ jsx15(X12, { size: 18, color: "#8A97A3" }) })
    ] }),
    /* @__PURE__ */ jsx15("div", { className: "flex flex-col gap-2.5", children: rows.map((r, i) => /* @__PURE__ */ jsxs15("div", { className: "rounded-xl p-3.5", style: { background: "#F4F6F8" }, children: [
      /* @__PURE__ */ jsx15("p", { className: "text-[11px] font-bold mb-1", style: { color: "#8A97A3" }, children: r.label }),
      r.person ? /* @__PURE__ */ jsxs15("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsx15(ShieldCheck3, { size: 14, color: "#B25E09" }),
        /* @__PURE__ */ jsx15("span", { className: "text-sm font-black", style: { color: "#16222E" }, children: r.person.name }),
        /* @__PURE__ */ jsxs15("span", { className: "text-[11px]", style: { color: "#8A97A3" }, children: [
          "(",
          r.person.employeeId,
          ")"
        ] })
      ] }) : /* @__PURE__ */ jsx15("p", { className: "text-sm font-bold", style: { color: "#C0392B" }, children: t("noneAssigned") }),
      isSectionSupervisor && r.candidates.length > 0 && /* @__PURE__ */ jsxs15("div", { className: "mt-2 pt-2", style: { borderTop: "1px solid #E2E8ED" }, children: [
        /* @__PURE__ */ jsxs15("p", { className: "text-[10px] font-bold mb-1", style: { color: "#8A97A3" }, children: [
          t("adminOverrideBtn"),
          ":"
        ] }),
        /* @__PURE__ */ jsx15("div", { className: "flex flex-wrap gap-1", children: r.candidates.map((c) => /* @__PURE__ */ jsx15("button", { onClick: () => adminOverrideInCharge(c.id), disabled: c.inCharge, className: "text-[10px] font-bold px-2 py-1 rounded-md", style: { background: c.inCharge ? "#FBEEDF" : "#FFFFFF", color: c.inCharge ? "#B25E09" : "#5B6B79", border: "1px solid #E2E8ED", opacity: c.inCharge ? 0.7 : 1 }, children: c.name }, c.id)) })
      ] })
    ] }, i)) }),
    /* @__PURE__ */ jsx15("button", { onClick: () => {
...
function HandoverHistoryModal(ctx) {
  ...
  return /* @__PURE__ */ jsx15("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", style: { background: "rgba(22,34,46,0.45)" }, onClick: () => setHandoverHistoryOpen(false), children: /* @__PURE__ */ jsxs15("div", { className: "w-full max-w-sm rounded-xl p-4 max-h-[80vh] overflow-y-auto", style: { background: "#FFFFFF" }, onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs15("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsx15("h3", { className: "text-base font-black", style: { color: "#16222E" }, children: t("handoverHistoryTitle") }),
      /* @__PURE__ */ jsx15("button", { onClick: () => setHandoverHistoryOpen(false), children: /* @__PURE__ */ jsx15(X12, { size: 18, color: "#8A97A3" }) })
    ] }),
    handoverHistory.length === 0 && /* @__PURE__ */ jsx15("p", { className: "text-xs text-center py-6", style: { color: "#8A97A3" }, children: t("noHandoverHistory") }),
    /* @__PURE__ */ jsx15("div", { className: "flex flex-col gap-2", children: handoverHistory.map((h) => /* @__PURE__ */ jsxs15("div", { className: "rounded-lg p-3", style: { background: "#F4F6F8" }, children: [
      /* @__PURE__ */ jsxs15("div", { className: "flex items-center gap-1.5 text-sm mb-1", children: [
        /* @__PURE__ */ jsx15("span", { className: "font-bold", style: { color: "#16222E" }, children: h.fromName || "\u2014" }),
        /* @__PURE__ */ jsx15(ArrowLeftRight2, { size: 12, color: "#8A97A3" }),
        /* @__PURE__ */ jsx15("span", { className: "font-bold", style: { color: "#16222E" }, children: h.toName })
      ] }),
      /* @__PURE__ */ jsxs15("p", { className: "text-[11px]", style: { color: "#8A97A3" }, children: [
        h.role,
        " \xB7 ",
...
function HandoverPicker(ctx) {
  ...
  return /* @__PURE__ */ jsx15("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", style: { background: "rgba(22,34,46,0.45)" }, onClick: () => setHandoverPickerOpen(false), children: /* @__PURE__ */ jsxs15("div", { className: "w-full max-w-sm rounded-xl p-4 max-h-[75vh] overflow-y-auto", style: { background: "#FFFFFF" }, onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ jsxs15("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsx15("h3", { className: "text-base font-black", style: { color: "#16222E" }, children: t("handoverPickerTitle") }),
      /* @__PURE__ */ jsx15("button", { onClick: () => setHandoverPickerOpen(false), children: /* @__PURE__ */ jsx15(X12, { size: 18, color: "#8A97A3" }) })
    ] }),
    colleagues.length === 0 && /* @__PURE__ */ jsx15("p", { className: "text-xs text-center py-6", style: { color: "#8A97A3" }, children: t("noEligibleColleagues") }),
    /* @__PURE__ */ jsx15("div", { className: "flex flex-col gap-2", children: colleagues.map((p) => /* @__PURE__ */ jsxs15("div", { className: "rounded-xl p-3 flex items-center justify-between gap-2", style: { background: "#F4F6F8" }, children: [
      /* @__PURE__ */ jsxs15("div", { children: [
        /* @__PURE__ */ jsx15("p", { className: "text-sm font-bold", style: { color: "#16222E" }, children: p.name }),
        /* @__PURE__ */ jsxs15("p", { className: "text-[11px]", style: { color: "#8A97A3" }, children: [
          p.employeeId,
          " \xB7 ",
          p.department
      ...
      /* @__PURE__ */ jsx15("button", { onClick: () => requestHandover(p.id), className: "text-[11px] font-bold px-3 py-1.5 rounded-lg shrink-0", style: { background: "#1F4E79", color: "white" }, children: t("sendRequestBtn") })
    ] }, p.id)) })
  ] }) });
}

// source/App.jsx
import { Fragment as Fragment9, jsx as jsx16, jsxs as jsxs16 } from "react/jsx-runtime";
...
function TaskManagerInner() {
  ...
  const LAB_UNITS = ["Gas", "Condensate", "Water", "Oil"];
  const [labReportsLog, setLabReportsLog] = useState(initialSnapshot?.labReportsLog || []);
  const [labUnitTab, setLabUnitTab] = useState("Gas");
  const [labViewDate, setLabViewDate] = useState(today2);
  const [labDateSearchOpen, setLabDateSearchOpen] = useState(false);
  ...
  const [dailySection, setDailySection] = useState("production");
  ...
  const [readNotifIds, setReadNotifIds] = useState(initialSnapshot?.readNotifIds || []);
  ...
  const notifications = useMemo(() => {
    ...
    const dueTomorrow = scope.filter((tk) => tk.status !== "completed" && tk.endDate === tomorrow).map((tk) => ({ id: `task-tmrw-${tk.id}`, kind: "\u2192", text: tk.title, nav: { type: "task", id: tk.id } }));
    const dueToday = scope.filter((tk) => tk.status !== "completed" && tk.endDate === today2).map((tk) => ({ id: `task-today-${tk.id}`, kind: t("today"), text: tk.title, nav: { type: "task", id: tk.id } }));
    const commentNotifs = scope.filter((tk) => tk.assignees.includes(currentUserId)).flatMap((tk) => tk.comments.filter((c) => c.author !== actingAs).map((c) => ({ id: `task-comment-${tk.id}-${c.id}`, kind: "\u{1F4AC}", text: `${c.author}: ${tk.title}`, nav: { type: "task", id: tk.id } })));
    const myTurnStatus = (s) => isShiftSupervisor && isShiftTurn(s) || isSectionSupervisor && isSectionTurn(s);
    const problemNotifs = problems.filter((p) => p.department === viewer.department && myTurnStatus(p.reviewStatus)).map((p) => ({ id: `problem-${p.id}`, kind: "!", text: p.title, nav: { type: "problem", id: p.id } }));
    const criticalNotifs = isCoordinator ? problems.filter((p) => p.priority === "high" && p.reviewStatus === "approved_final").map((p) => ({ id: `problem-critical-${p.id}`, kind: "\u203C", text: p.title, nav: { type: "problem", id: p.id } })) : [];
    const readingAlertNotifs = isShiftSupervisor ? readingsLog.filter((r) => r.department === viewer.department).flatMap((r) => (r.notes || []).filter((n) => n.severity === "warning" || n.severity === "critical").map((n) => ({ id: `reading-alert-${r.id}-${n.id}`, kind: n.severity === "critical" ? "\u203C" : "!", text: n.description || n.equipmentName, nav: { type: "readings", date: r.dateISO } }))) : [];
    const readingReviewNotifs = readingsLog.filter((r) => r.department === viewer.department && myTurnStatus(r.reviewStatus)).map((r) => ({ id: `reading-review-${r.id}`, kind: "!", text: t("readings") + ": " + (r.attachment?.name || r.createdAt), nav: { type: "readings", date: r.dateISO } }));
    const reportReviewNotifs = reportsLog.filter((r) => r.department === viewer.department && myTurnStatus(r.reviewStatus)).map((r) => ({ id: `report-review-${r.id}`, kind: "!", text: t("reportsMenu") + ": " + (r.attachment?.name || r.createdAt), nav: { type: "reports", date: r.dateISO, tab: r.period ? "periodic" : "daily" } }));
    const all = [...dueToday, ...dueTomorrow, ...commentNotifs, ...problemNotifs, ...criticalNotifs, ...readingAlertNotifs, ...readingReviewNotifs, ...reportReviewNotifs];
    return all.map((n) => ({ ...n, read: readNotifIds.includes(n.id) }));
  }, [tasks, problems, readingsLog, reportsLog, currentUserId, actingAs, viewerRole, viewer.department, isShiftSupervisor, isSectionSupervisor, isCoordinator, lang, readNotifIds]);
  function goToNotification(n) {
    markNotifRead(n.id);
    if (n.nav.type === "task") {
      setActiveOverlay(null);
      setMainSubTab("tasks");
      setExpandedId(n.nav.id);
    } else if (n.nav.type === "problem") {
      setActiveOverlay(null);
      setMainSubTab("problems");
      setExpandedProblemId(n.nav.id);
    } else if (n.nav.type === "readings") {
      setReadingsViewDate(n.nav.date);
      setReadingsTab("history");
      setActiveOverlay("readings");
    } else if (n.nav.type === "reports") {
      setReportsViewDate(n.nav.date);
      setReportsTab(n.nav.tab || "daily");
  ...
  }, [lang, departments, roles, people, tasks, problems, readingsLog, reportsLog, labReportsLog, menuPermissions, logbookNotes, activityLog, currentUserId, handoverRequests, handoverHistory, autoHandover, readNotifIds]);
  return /* @__PURE__ */ jsxs16("div", { dir: lang === "en" ? "ltr" : "rtl", className: "min-h-screen w-full", style: { background: "#EEF1F4", fontFamily: lang === "en" ? "system-ui, sans-serif" : "'Tajawal', sans-serif" }, children: [
    ...
    ToastStack(ctx),
    ConfirmDialog(ctx),
    /* @__PURE__ */ jsxs16("div", { className: "max-w-3xl mx-auto px-4 py-6", children: [
      /* @__PURE__ */ jsxs16("div", { className: "rounded-xl p-2.5 mb-4 flex items-center gap-2", style: { background: "#FFF6EB", border: "1px solid #F0C57A" }, children: [
        /* @__PURE__ */ jsx16("span", { className: "text-xs font-bold", style: { color: "#5B4321" }, children: t("previewAs") }),
        /* @__PURE__ */ jsx16("select", { value: currentUserId, onChange: (e) => setCurrentUserId(Number(e.target.value)), className: "text-xs outline-none flex-1", style: { ...inputStyle, padding: "6px 10px" }, children: people.map((p) => /* @__PURE__ */ jsxs16("option", { value: p.id, children: [
          p.name,
          " (",
          p.employeeId,
          ") \u2014 ",
        ...
        /* @__PURE__ */ jsxs16("button", { onClick: () => setLang(lang === "ar" ? "en" : "ar"), className: "flex items-center gap-1 text-xs font-bold px-2.5 py-1.5 rounded-lg shrink-0", style: { background: "#FFFFFF", border: "1px solid #F0C57A", color: "#5B4321" }, children: [
          /* @__PURE__ */ jsx16(Languages2, { size: 13 }),
          " ",
          lang === "ar" ? "EN" : "AR"
        ] })
      ] }),
      viewerRole === "admin" ? /* @__PURE__ */ jsxs16(Fragment9, { children: [
        /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-3 mb-5", children: [
          Avatar(ctx, viewer.department, 48),
          /* @__PURE__ */ jsxs16("div", { children: [
            /* @__PURE__ */ jsx16("p", { className: "text-base font-black", style: { color: "#16222E" }, children: viewer.name }),
            /* @__PURE__ */ jsx16("p", { className: "text-[11px]", style: { color: "#8A97A3" }, children: viewer.employeeId }),
            /* @__PURE__ */ jsx16("p", { className: "text-xs", style: labelStyle, children: t("appAdmin") })
          ] })
        ] }),
        AdminView(ctx)
      ] }) : /* @__PURE__ */ jsxs16(Fragment9, { children: [
        /* @__PURE__ */ jsxs16("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs16("div", { children: [
              /* @__PURE__ */ jsx16("p", { className: "text-base font-black", style: { color: "#16222E" }, children: viewer.name }),
              /* @__PURE__ */ jsx16("p", { className: "text-[11px]", style: { color: "#8A97A3" }, children: viewer.employeeId }),
              /* @__PURE__ */ jsx16("p", { className: "text-xs", style: labelStyle, children: viewer.role }),
              dutyMinutesLeft != null && /* @__PURE__ */ jsxs16("p", { className: "flex items-center gap-1 text-[11px] font-bold mt-0.5", style: { color: dutyMinutesLeft <= 30 ? "#C0392B" : "#8A97A3" }, children: [
                /* @__PURE__ */ jsx16(Clock2, { size: 11 }),
                " ",
                t("dutyTimeLeft"),
                " ",
          ...
          /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx16("div", { className: "relative", children: /* @__PURE__ */ jsxs16("button", { onClick: () => setActiveOverlay("notifications"), className: "w-12 h-12 rounded-full flex items-center justify-center relative", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
              /* @__PURE__ */ jsx16(Bell2, { size: 22, color: "#16222E" }),
              notifications.filter((n) => !n.read).length > 0 && /* @__PURE__ */ jsx16("span", { className: "absolute -top-1 -left-1 text-[10px] font-bold rounded-full flex items-center justify-center", style: { width: 18, height: 18, background: "#C0392B", color: "white" }, children: notifications.filter((n) => !n.read).length })
            ] }) }),
            hasDrawer && /* @__PURE__ */ jsx16("button", { onClick: () => setDrawerOpen(true), className: "w-11 h-11 rounded-full flex items-center justify-center", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx16(Menu2, { size: 19, color: "#16222E" }) })
          ] })
        ] }),
        HandoverBanner(ctx),
        HandoverPicker(ctx),
        ...
        activeOverlay === "notifications" && NotificationsOverlay(ctx),
        !activeOverlay && /* @__PURE__ */ jsxs16(Fragment9, { children: [
          /* @__PURE__ */ jsxs16("div", { className: "flex gap-2 mb-3", children: [
            !isCoordinator && /* @__PURE__ */ jsx16("button", { onClick: () => setMainSubTab("tasks"), className: "flex-1 text-base font-black py-3 rounded-xl", style: { background: mainSubTab === "tasks" ? "#1F4E79" : "#FFFFFF", color: mainSubTab === "tasks" ? "white" : "#5B6B79", border: "1px solid " + (mainSubTab === "tasks" ? "#1F4E79" : "#DCE3E8") }, children: t("tasks") }),
            /* @__PURE__ */ jsxs16("button", { onClick: () => setMainSubTab("problems"), className: "flex-1 text-base font-black py-3 rounded-xl", style: { background: mainSubTab === "problems" ? "#1F4E79" : "#FFFFFF", color: mainSubTab === "problems" ? "white" : "#5B6B79", border: "1px solid " + (mainSubTab === "problems" ? "#1F4E79" : "#DCE3E8") }, children: [
              t("problems"),
              " ",
          ...
          isAdvisory && /* @__PURE__ */ jsx16("p", { className: "text-xs mb-3 px-1", style: { color: "#B25E09" }, children: t("advisoryNote") }),
          isCoordinator && /* @__PURE__ */ jsx16("p", { className: "text-xs mb-3 px-1", style: { color: "#B25E09" }, children: t("coordinatorNote") }),
          mainSubTab === "tasks" && viewerRole === "supervisor" && /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsx16("button", { onClick: () => setSupTasksTab("list"), className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", title: t("todayTaskList"), style: { background: supTasksTab === "list" ? "#1F4E79" : "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx16(List, { size: 19, color: supTasksTab === "list" ? "white" : "#16222E" }) }),
            canManage && /* @__PURE__ */ jsx16("button", { onClick: () => {
              setTaskForm(emptyTaskForm());
              setEditingId(null);
              setShowTaskForm(true);
            }, className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", style: { background: "#1F4E79" }, children: /* @__PURE__ */ jsx16(Plus3, { size: 20, color: "white" }) }),
            /* @__PURE__ */ jsx16("button", { onClick: () => setSupTasksTab((s) => s === "inprogress" ? "list" : "inprogress"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: supTasksTab === "inprogress" ? "#1F4E79" : "#FFFFFF", color: supTasksTab === "inprogress" ? "white" : "#5B6B79", border: "1px solid " + (supTasksTab === "inprogress" ? "#1F4E79" : "#DCE3E8") }, children: t("inProgressBtn") }),
            /* @__PURE__ */ jsx16("button", { onClick: () => setSupTasksTab((s) => s === "completed" ? "list" : "completed"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: supTasksTab === "completed" ? "#1F4E79" : "#FFFFFF", color: supTasksTab === "completed" ? "white" : "#5B6B79", border: "1px solid " + (supTasksTab === "completed" ? "#1F4E79" : "#DCE3E8") }, children: t("completedBtn") })
          ] }),
          mainSubTab === "problems" && /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsx16("button", { onClick: () => setProblemView("status"), className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", title: t("problemsList"), style: { background: problemView === "status" ? "#1F4E79" : "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx16(List, { size: 19, color: problemView === "status" ? "white" : "#16222E" }) }),
            (viewerRole === "operator" || canManage) && /* @__PURE__ */ jsx16("button", { onClick: () => {
              setShowProblemForm(true);
            }, className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", style: { background: "#1F4E79" }, children: /* @__PURE__ */ jsx16(Plus3, { size: 20, color: "white" }) }),
            /* @__PURE__ */ jsx16("button", { onClick: () => setProblemSearchOpen((o) => !o), className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", style: { background: problemSearchOpen ? "#1F4E79" : "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx16(Search5, { size: 18, color: problemSearchOpen ? "white" : "#16222E" }) }),
            !isCoordinator && /* @__PURE__ */ jsxs16("button", { onClick: () => setProblemView((s) => s === "log" ? "status" : "log"), className: "flex-1 flex items-center justify-center gap-1.5 text-sm font-bold py-2.5 rounded-lg", style: { background: problemView === "log" ? "#1F4E79" : "#FFFFFF", color: problemView === "log" ? "white" : "#5B6B79", border: "1px solid " + (problemView === "log" ? "#1F4E79" : "#DCE3E8") }, children: [
              /* @__PURE__ */ jsx16(Clock2, { size: 15 }),
              " ",
              t("fullLog")
            ] })
          ] }),
          mainSubTab === "problems" && problemSearchOpen && /* @__PURE__ */ jsxs16("div", { className: "rounded-xl p-3 mb-4 flex flex-col gap-2", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
            /* @__PURE__ */ jsx16("input", { autoFocus: true, value: problemSearch, onChange: (e) => setProblemSearch(e.target.value), placeholder: t("searchPlaceholder"), className: "w-full text-sm outline-none", style: inputStyle }),
            /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsx16("span", { className: "text-[11px] font-bold", style: { color: "#8A97A3" }, children: t("searchField") }),
              [["all", t("all")], ["tagNumber", t("fieldTag")], ["equipmentName", t("fieldEquip")], ["department", t("fieldDept")], ["location", t("fieldLoc")]].map(([k, l]) => /* @__PURE__ */ jsx16("button", { onClick: () => setProblemSearchField(k), className: "text-[11px] font-bold px-2.5 py-1 rounded-full", style: { background: problemSearchField === k ? "#1F4E79" : "#F4F6F8", color: problemSearchField === k ? "white" : "#5B6B79" }, children: l }, k))
            ] })
          ] }),
          mainSubTab === "tasks" && showTaskForm && canManage && /* @__PURE__ */ jsx16(TaskFormPanel, { ctx }),
          mainSubTab === "problems" && showProblemForm && /* @__PURE__ */ jsx16(ProblemFormPanel, { ctx }),
          mainSubTab === "tasks" && /* @__PURE__ */ jsxs16(Fragment9, { children: [
            RenewalReviewBlock(ctx),
            AlertsBlock(ctx),
            TaskPreApprovalBlock(ctx),
            TaskReturnedPreBlock(ctx),
            viewerRole === "operator" ? /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-2.5", children: [
              deptTasks.length === 0 && /* @__PURE__ */ jsxs16("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: [
                t("noTasks"),
                "."
              ] }),
          ...
          isCoordinator && tasksVisibleToCoordinator.length > 0 && /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-2.5 mb-5", children: [
            /* @__PURE__ */ jsx16("h3", { className: "text-sm font-black px-1", style: { color: "#B25E09" }, children: t("coordinatorTasksTitle") }),
            tasksVisibleToCoordinator.map((tk, i) => TaskCard(ctx, tk, true, i + 1))
          ] }),
          mainSubTab === "problems" && problemView === "status" && /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-5", children: [
            Object.entries(WORK_STATUS).map(([k, v]) => {
              ...
              return /* @__PURE__ */ jsxs16("div", { children: [
                /* @__PURE__ */ jsx16("h4", { className: "text-sm font-black mb-2 px-1", style: { color: v.color }, children: v[lang] || v.ar }),
                /* @__PURE__ */ jsx16("div", { className: "flex flex-col gap-2.5", children: list.map((p) => ProblemCard(ctx, p, { withApprove: true })) })
              ] }, k);
            }),
            problemsVisibleToViewer.filter(matchesProblemSearch).length === 0 && /* @__PURE__ */ jsx16("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: t("noProblems") })
          ] }),
          mainSubTab === "problems" && problemView === "log" && /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-2.5", children: [
            problemsChrono.filter(matchesProblemSearch).length === 0 && /* @__PURE__ */ jsx16("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: t("noProblems") }),
...
function TaskManager() {
  return /* @__PURE__ */ jsx16(ErrorBoundary, { children: /* @__PURE__ */ jsx16(TaskManagerInner, {}) });
}
export {
