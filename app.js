...
function ReportsOverlay(ctx) {
  ...
  const isOperatorView = viewerRole === "operator" && !canManage;
  const effectiveReportsTab = isOperatorView ? "periodic" : reportsTab;
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-3", children: [
    ...
    !isOperatorView && /* @__PURE__ */ jsxs10("div", { className: "flex gap-2 mb-1", children: [
    ...
    effectiveReportsTab === "daily" && /* @__PURE__ */ jsxs10(Fragment7, { children: [
      ...
      /* @__PURE__ */ jsx10("p", { className: "text-sm font-black px-1 mt-1", style: { color: "#B25E09" }, children: t("labReportTitle") }),
      ...
      /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx10("button", { onClick: () => setLabDateSearchOpen(!labDateSearchOpen), className: "w-9 h-9 rounded-lg flex items-center justify-center shrink-0", style: { background: labDateSearchOpen ? "#1F4E79" : "#FFFFFF", border: "1px solid " + (labDateSearchOpen ? "#1F4E79" : "#DCE3E8") }, children: /* @__PURE__ */ jsx10(Search4, { size: 15, color: labDateSearchOpen ? "white" : "#16222E" }) }),
        /* @__PURE__ */ jsxs10("div", { className: "flex-1 flex items-center justify-between rounded-xl p-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
          /* @__PURE__ */ jsx10("button", { onClick: () => setLabViewDate((d) => shiftISODate(d, -1)), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx10(ChevronUp4, { size: 16, style: { transform: "rotate(-90deg)" }, color: "#16222E" }) }),
          /* @__PURE__ */ jsx10("p", { className: "text-sm font-black", style: { color: "#16222E" }, children: labViewDate === today2 ? t("todayLbl") : labViewDate }),
          /* @__PURE__ */ jsx10("button", { onClick: () => setLabViewDate((d) => shiftISODate(d, 1)), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx10(ChevronUp4, { size: 16, style: { transform: "rotate(90deg)" }, color: "#16222E" }) })
        ] })
      ] }),
      labDateSearchOpen && /* @__PURE__ */ jsx10("div", { className: "rounded-xl p-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx10("input", { type: "date", value: labViewDate, onChange: (e) => {
        setLabViewDate(e.target.value);
        setLabDateSearchOpen(false);
      }, className: "w-full text-sm outline-none", style: inputStyle }) }),
      /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-2.5", children: [
    ...
    /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      ...
      /* @__PURE__ */ jsx14("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs14("table", { className: "w-full text-xs", style: { borderCollapse: "collapse" }, children: [
        ...
        /* @__PURE__ */ jsx14("tbody", { children: [...SUPERVISOR_ROLES, ...OPERATOR_ROLES].map((role) => /* @__PURE__ */ jsxs14("tr", { style: { borderTop: "1px solid #EEF1F4" }, children: [
          ...
          MENU_ITEM_DEFS.map((it) => /* @__PURE__ */ jsx14("td", { className: "py-2 px-2 text-center", children: /* @__PURE__ */ jsx14("input", { type: "checkbox", checked: (menuPermissions[role] || []).includes(it.key), onChange: () => toggleMenuPermission(role, it.key) }) }, it.key))
        ] }, role)) })
      ] }) })
    ] })
  ] });
...
function TaskManagerInner() {
  ...
  const LAB_UNITS = ["Gas", "Condensate", "Water Treatment", "Oil"];
