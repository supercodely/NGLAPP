// App.jsx
import React, { useState, useMemo, useRef as useRef2, useEffect } from "react";
import {
  Plus as Plus3,
  Trash2 as Trash23,
  Pencil as Pencil3,
  ...
  Gauge as Gauge2,
  ArrowLeftRight as ArrowLeftRight2,
  List,
  Repeat as Repeat2,
  Clock,
  Search as Search3,
...
function BtnContent2(ctx, key, label) {
  const {
    MONTHS,
    PALETTE,
    STATUS_WEIGHT,
...
// components/TaskComponents.jsx
import { Trash2, Pencil, Lock, Globe2, ChevronDown, ChevronUp, Send, CheckCircle2, CalendarDays as CalendarDays2, AlertTriangle as AlertTriangle2, X, Play, Repeat } from "lucide-react";
...
function StatusControl(ctx, task) {
  ...
  if (task.status === "not_started") return /* @__PURE__ */ jsxs2("button", { onClick: () => setStatus(task.id, "in_progress"), className: "flex items-center gap-1 text-[11px] font-bold px-3 py-1.5 rounded-lg", style: { background: "#1F4E79", color: "white" }, children: [
    /* @__PURE__ */ jsx2(Play, { size: 11 }),
    " ",
    t("start")
  ] });
  if (task.status === "in_progress") return /* @__PURE__ */ jsxs2("button", { onClick: () => setStatus(task.id, "completed"), className: "flex items-center gap-1 text-[11px] font-bold px-3 py-1.5 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: [
    /* @__PURE__ */ jsx2(CheckCircle2, { size: 11 }),
    " ",
    t("markDone")
  ] });
  return /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsxs2("span", { className: "flex items-center gap-1 text-[11px] font-bold px-3 py-1.5 rounded-lg", style: { background: "#E4F3EA", color: "#2F7D4F" }, children: [
      /* @__PURE__ */ jsx2(CheckCircle2, { size: 11 }),
      " ",
      t("completed")
    ] }),
    /* @__PURE__ */ jsx2("button", { onClick: () => setStatus(task.id, "in_progress"), className: "text-[11px] underline", style: { color: "#8A97A3" }, children: t("reopen") })
  ] });
}
function TaskCard(ctx, task, showDept, numberIdx) {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-start justify-between gap-3", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex-1 min-w-0", children: [
        /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2 flex-wrap mb-1", children: [
          numberIdx != null && /* @__PURE__ */ jsxs2("span", { className: "text-xs font-black", style: { color: "#8A97A3" }, children: [
            numberIdx,
            "."
          ] }),
          /* @__PURE__ */ jsx2("h3", { className: "text-base font-black", style: { color: "#16222E" }, children: task.title }),
          /* @__PURE__ */ jsx2("span", { className: "text-[11px] font-bold px-2 py-0.5 rounded-full", style: { background: pr.bg, color: pr.color }, children: pr[lang] || pr.ar }),
          showDept && /* @__PURE__ */ jsx2("span", { className: "text-[11px] font-bold px-2 py-0.5 rounded-full", style: { background: deptColor(task.department).bg, color: deptColor(task.department).text }, children: task.department }),
          task.type === "private" && /* @__PURE__ */ jsxs2("span", { className: "flex items-center gap-1 text-[11px] font-bold px-2 py-0.5 rounded-full", style: { background: "#FBEEDF", color: "#B25E09" }, children: [
            /* @__PURE__ */ jsx2(Lock, { size: 11 }),
            " ",
            t("private")
          ] }),
          task.recurrenceGroupId && /* @__PURE__ */ jsxs2("span", { className: "flex items-center gap-1 text-[11px] font-bold px-2 py-0.5 rounded-full", style: { background: "#E9F3FB", color: "#0E7490" }, children: [
            /* @__PURE__ */ jsx2(Repeat, { size: 11 }),
            " ",
            t("recurringBadge")
          ] })
        ] }),
        /* @__PURE__ */ jsx2("p", { className: "text-xs", style: { color: "#5B6B79" }, children: (task.dates || []).join(", ") || `${task.startDate} \u2192 ${task.endDate}` })
      ] }),
      /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-1 shrink-0", children: [
        canManage && /* @__PURE__ */ jsxs2(Fragment, { children: [
          /* @__PURE__ */ jsx2("button", { onClick: () => startEditTask(task), className: "w-7 h-7 rounded-md flex items-center justify-center", style: { color: "#5B6B79" }, children: /* @__PURE__ */ jsx2(Pencil, { size: 14 }) }),
          /* @__PURE__ */ jsx2("button", { onClick: () => deleteTask(task.id), className: "w-7 h-7 rounded-md flex items-center justify-center", style: { color: "#C0392B" }, children: /* @__PURE__ */ jsx2(Trash2, { size: 14 }) })
        ] }),
        /* @__PURE__ */ jsx2("button", { onClick: () => setExpandedId(isExpanded ? null : task.id), className: "w-7 h-7 rounded-md flex items-center justify-center", style: { color: "#1F4E79" }, children: isExpanded ? /* @__PURE__ */ jsx2(ChevronUp, { size: 16 }) : /* @__PURE__ */ jsx2(ChevronDown, { size: 16 }) })
      ] })
    ] }),
    /* @__PURE__ */ jsx2("div", { className: "mt-3 pt-3 flex items-center gap-2", style: { borderTop: "1px solid #EEF1F4" }, children: StatusControl(ctx, task) }),
    isExpanded && /* @__PURE__ */ jsxs2("div", { className: "mt-3 pt-3 flex flex-col gap-2 text-xs", style: { borderTop: "1px solid #EEF1F4", color: "#5B6B79" }, children: [
      task.description && /* @__PURE__ */ jsx2("p", { children: task.description }),
      /* @__PURE__ */ jsxs2("p", { children: [
        t("createdByLbl"),
        " ",
        /* @__PURE__ */ jsx2("b", { style: { color: "#16222E" }, children: personLabel(task.createdBy) }),
        " \u2014 ",
        task.createdAt
      ] }),
      /* @__PURE__ */ jsxs2("p", { children: [
        t("assignedToLbl"),
        " ",
        /* @__PURE__ */ jsx2("b", { style: { color: "#16222E" }, children: task.assignees.map((id) => personLabel(id)).join(", ") || "\u2014" })
      ] }),
      task.recurrence && task.recurrence.type !== "none" && /* @__PURE__ */ jsxs2("p", { children: [
        t("recurrence"),
        ": ",
        /* @__PURE__ */ jsx2("b", { style: { color: "#16222E" }, children: task.recurrence.type === "daily" ? t("recDaily") : task.recurrence.type === "weekly" ? task.recurrence.weekdays.join(", ") : task.recurrence.monthDays.join(", ") })
      ] }),
      /* @__PURE__ */ jsxs2("div", { className: "mt-2 flex flex-col gap-2", children: [
        task.comments.map((c) => /* @__PURE__ */ jsxs2("div", { className: "rounded-lg px-3 py-2", style: { background: "#F4F6F8" }, children: [
          ...
          /* @__PURE__ */ jsx2("p", { children: c.text })
        ] }, c.id)),
        /* @__PURE__ */ jsxs2("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx2("input", { value: commentDraft, onChange: (e) => setCommentDraft(e.target.value), onKeyDown: (e) => {
            if (e.key === "Enter") {
              e.preventDefault();
              addComment(task.id);
            }
          }, placeholder: `${t("commentPH")} ${actingAs}...`, className: "flex-1 text-xs outline-none", style: { ...inputStyle, padding: "8px 10px" } }),
          /* @__PURE__ */ jsx2("button", { onClick: () => addComment(task.id), className: "w-8 h-8 rounded-lg flex items-center justify-center shrink-0", style: { background: "#1F4E79" }, children: /* @__PURE__ */ jsx2(Send, { size: 13, color: "white" }) })
        ] })
      ] })
    ] })
  ] }, task.id);
...
function AlertsBlock(ctx) {
  ...
  return /* @__PURE__ */ jsx2("div", { className: "flex flex-col gap-2 mb-4", children: alerts.map((tk) => /* @__PURE__ */ jsxs2("div", { className: "rounded-xl p-3.5 flex flex-col gap-2", style: { background: "#FFF6EB", border: "1px solid #F0C57A" }, children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between gap-3 flex-wrap", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx2(AlertTriangle2, { size: 16, color: "#B25E09" }),
        /* @__PURE__ */ jsxs2("span", { className: "text-sm", style: { color: "#5B4321" }, children: [
          t("dueSoon"),
          " ",
          /* @__PURE__ */ jsxs2("span", { className: "text-base font-black", children: [
            "\xAB",
            tk.title,
            "\xBB"
          ] }),
      ...
      extendingAlertId !== tk.id && /* @__PURE__ */ jsxs2("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsx2("button", { onClick: () => setStatus(tk.id, "completed"), className: "text-xs font-bold px-3 py-1.5 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: t("yesDone") }),
    ...
    extendingAlertId === tk.id && /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-2 mt-1", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex flex-col sm:flex-row gap-2", children: [
        /* @__PURE__ */ jsx2("input", { type: "date", value: extendDate, onChange: (e) => setExtendDate(e.target.value), className: "text-sm outline-none flex-1", style: inputStyle }),
        /* @__PURE__ */ jsx2("textarea", { value: extendComment, onChange: (e) => setExtendComment(e.target.value), placeholder: t("postponeReasonReq"), rows: 2, className: "text-sm outline-none flex-[2] resize-none", style: inputStyle })
      ] }),
      /* @__PURE__ */ jsxs2("div", { className: "flex gap-2 self-start", children: [
        /* @__PURE__ */ jsx2("button", { disabled: !extendComment.trim(), onClick: () => confirmExtend(tk.id), className: "text-xs font-bold px-4 py-1.5 rounded-lg", style: { background: extendComment.trim() ? "#1F4E79" : "#C3CBD1", color: "white" }, children: t("confirmPostpone") }),
        /* @__PURE__ */ jsx2("button", { onClick: () => setExtendingAlertId(null), className: "text-xs font-bold px-4 py-1.5 rounded-lg", style: { background: "#FFFFFF", color: "#5B6B79", border: "1px solid #E2E8ED" }, children: t("back") })
      ] })
    ] })
  ] }, tk.id)) });
}
function MiniMonthGrid(ctx, monthDate, selectedDates, onToggle) {
  ...
  return /* @__PURE__ */ jsxs2("div", { className: "rounded-lg overflow-hidden", style: { border: "1px solid #DCE3E8" }, children: [
    /* @__PURE__ */ jsx2("div", { className: "grid grid-cols-7", style: { background: "#F4F6F8" }, children: WEEKDAYS.map((w) => /* @__PURE__ */ jsx2("div", { className: "text-[10px] font-bold text-center py-1.5", style: labelStyle, children: w }, w)) }),
    /* @__PURE__ */ jsx2("div", { className: "grid grid-cols-7", children: grid.map((d) => {
      const ds = toISODate(d);
      const inMonth = d.getMonth() === monthDate.getMonth();
      const active = selectedDates.includes(ds);
      const isToday = ds === today;
      return /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => onToggle(ds), className: "h-9 text-xs font-bold", style: { background: active ? "#1F4E79" : "#FFFFFF", color: active ? "white" : inMonth ? "#16222E" : "#C3CBD1", border: isToday && !active ? "1px solid #1F4E79" : "1px solid #EEF1F4" }, children: d.getDate() }, ds);
    }) })
  ] });
}
function TaskFormPanel2(ctx) {
  const {
    MONTHS,
    PALETTE,
    STATUS_WEIGHT,
  ...
  return /* @__PURE__ */ jsxs2("form", { ref: formRef, onSubmit: submitTask, className: "rounded-xl p-4 mb-4 flex flex-col gap-3", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsx2("h3", { className: "text-sm font-bold", style: { color: "#16222E" }, children: editingId ? t("editTask") : t("newTask") }),
      /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => {
        setShowTaskForm(false);
        setEditingId(null);
      }, children: /* @__PURE__ */ jsx2(X, { size: 16, color: "#8A97A3" }) })
    ] }),
    /* @__PURE__ */ jsx2("input", { value: taskForm.title, onChange: (e) => setTaskForm({ ...taskForm, title: e.target.value }), placeholder: t("taskTitle"), className: "w-full text-sm outline-none", style: inputStyle }),
    /* @__PURE__ */ jsx2("textarea", { value: taskForm.description, onChange: (e) => setTaskForm({ ...taskForm, description: e.target.value }), placeholder: t("descOpt"), rows: 2, className: "w-full text-sm outline-none resize-none", style: inputStyle }),
    /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx2("label", { className: "text-xs font-bold block mb-1", style: labelStyle, children: t("department") }),
      /* @__PURE__ */ jsx2("div", { className: "flex flex-col gap-1.5", children: departments.map((d) => /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => selectDeptForTask(d), className: "flex-1 flex items-center gap-2 text-sm font-bold px-3 py-2 rounded-lg text-left", style: { background: taskForm.department === d ? "#1F4E79" : "#F4F6F8", color: taskForm.department === d ? "white" : "#5B6B79" }, children: d }),
        /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => openCustomizeForTask(d), className: "text-xs font-bold px-3 py-2 rounded-lg shrink-0", style: { background: customizeDept === d ? "#B25E09" : "#F4F6F8", color: customizeDept === d ? "white" : "#5B6B79" }, children: t("customize") })
      ] }, d)) }),
      customizeDept && /* @__PURE__ */ jsx2("div", { className: "mt-2 p-2 rounded-lg flex flex-wrap gap-2", style: { background: "#F9FAFB", border: "1px solid #EEF1F4" }, children: departmentOperators(customizeDept).filter((p) => !p.onLeave).map((p) => {
        const active = taskForm.assignees.includes(p.id);
        return /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => toggleAssignee(p.id), className: "text-xs font-bold px-3 py-1.5 rounded-full", style: { background: active ? "#1F4E79" : "#FFFFFF", color: active ? "white" : "#5B6B79", border: "1px solid " + (active ? "#1F4E79" : "#E2E8ED") }, children: p.name }, p.id);
      }) }),
      /* @__PURE__ */ jsxs2("p", { className: "text-[11px] mt-1", style: { color: "#8A97A3" }, children: [
        taskForm.assignees.length,
        " ",
        t("assignees")
      ] })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "flex flex-col sm:flex-row gap-3", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex-1 flex gap-2", children: [
        /* @__PURE__ */ jsxs2("button", { type: "button", onClick: () => setTaskForm({ ...taskForm, type: "public" }), className: "flex-1 flex items-center justify-center gap-1.5 text-sm py-2 rounded-lg font-bold", style: { background: taskForm.type === "public" ? "#1F4E79" : "#F4F6F8", color: taskForm.type === "public" ? "white" : "#5B6B79" }, children: [
          /* @__PURE__ */ jsx2(Globe2, { size: 14 }),
          " ",
          t("public")
        ] }),
        /* @__PURE__ */ jsxs2("button", { type: "button", onClick: () => setTaskForm({ ...taskForm, type: "private" }), className: "flex-1 flex items-center justify-center gap-1.5 text-sm py-2 rounded-lg font-bold", style: { background: taskForm.type === "private" ? "#B25E09" : "#F4F6F8", color: taskForm.type === "private" ? "white" : "#5B6B79" }, children: [
          /* @__PURE__ */ jsx2(Lock, { size: 14 }),
          " ",
          t("private")
        ] })
      ] }),
      taskForm.type === "private" && /* @__PURE__ */ jsx2("select", { value: taskForm.privateTo, onChange: (e) => setTaskForm({ ...taskForm, privateTo: Number(e.target.value) }), className: "flex-1 text-sm outline-none", style: inputStyle, children: people.filter((p) => !p.isAdmin).map((p) => /* @__PURE__ */ jsxs2("option", { value: p.id, children: [
        p.name,
        " - ",
        p.role
      ] }, p.id)) })
    ...
    /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx2("label", { className: "text-xs font-bold block mb-1", style: labelStyle, children: t("priority") }),
      /* @__PURE__ */ jsx2("select", { value: taskForm.priority, onChange: (e) => setTaskForm({ ...taskForm, priority: e.target.value }), className: "w-full text-sm outline-none", style: inputStyle, children: Object.entries(PRIORITY).map(([k, v]) => /* @__PURE__ */ jsx2("option", { value: k, children: v[lang] || v.ar }, k)) })
    ] }),
    /* @__PURE__ */ jsxs2("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxs2("button", { type: "button", onClick: () => {
        ...
        /* @__PURE__ */ jsx2(CalendarDays2, { size: 15 }),
        " ",
      ...
      /* @__PURE__ */ jsxs2("button", { type: "button", onClick: () => {
        ...
        /* @__PURE__ */ jsx2(Repeat, { size: 15 }),
        " ",
        t("recurrence")
      ] })
    ] }),
    taskCalOpen && /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => setTaskCalMonth((d) => new Date(d.getFullYear(), d.getMonth() - 1, 1)), className: "text-xs font-bold px-2 py-1 rounded", style: { background: "#F4F6F8" }, children: t("prev") }),
        /* @__PURE__ */ jsxs2("span", { className: "text-xs font-bold", style: { color: "#16222E" }, children: [
          MONTHS[taskCalMonth.getMonth()],
          " ",
          taskCalMonth.getFullYear()
        ] }),
        /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => setTaskCalMonth((d) => new Date(d.getFullYear(), d.getMonth() + 1, 1)), className: "text-xs font-bold px-2 py-1 rounded", style: { background: "#F4F6F8" }, children: t("next") })
      ] }),
      MiniMonthGrid(ctx, taskCalMonth, taskForm.dates, toggleTaskDate)
    ] }),
    taskRecOpen && /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-2", children: [
      /* @__PURE__ */ jsx2("div", { className: "flex gap-2", children: [["none", t("recNone")], ["daily", t("recDaily")], ["weekly", t("recWeekly")], ["monthly", t("recMonthly")]].map(([k, l]) => /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => setTaskForm({ ...taskForm, recurrence: { ...taskForm.recurrence, type: k } }), className: "flex-1 text-xs font-bold py-2 rounded-lg", style: { background: taskForm.recurrence.type === k ? "#1F4E79" : "#F4F6F8", color: taskForm.recurrence.type === k ? "white" : "#5B6B79" }, children: l }, k)) }),
      taskForm.recurrence.type === "weekly" && /* @__PURE__ */ jsx2("div", { className: "flex flex-wrap gap-1.5", children: WEEKDAYS.map((w) => {
        const active = taskForm.recurrence.weekdays.includes(w);
        return /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => toggleRecWeekday(w), className: "text-xs font-bold px-2.5 py-1 rounded-full", style: { background: active ? "#1F4E79" : "#F4F6F8", color: active ? "white" : "#5B6B79" }, children: w }, w);
      }) }),
      taskForm.recurrence.type === "monthly" && /* @__PURE__ */ jsx2("div", { className: "grid grid-cols-7 gap-1", children: Array.from({ length: 31 }, (_, i) => i + 1).map((n) => {
        const active = taskForm.recurrence.monthDays.includes(n);
        return /* @__PURE__ */ jsx2("button", { type: "button", onClick: () => toggleRecMonthDay(n), className: "text-[11px] font-bold py-1.5 rounded", style: { background: active ? "#1F4E79" : "#F4F6F8", color: active ? "white" : "#5B6B79" }, children: n }, n);
      }) })
    ] }),
    /* @__PURE__ */ jsx2("button", { type: "submit", className: "text-sm font-bold py-2.5 rounded-lg", style: { background: "#16222E", color: "white" }, children: editingId ? t("save") : t("addTaskBtn") })
  ] });
}
function SupervisorTaskGroups(ctx, mode) {
  ...
  return /* @__PURE__ */ jsx2("div", { className: "flex flex-col gap-6", children: groups.map((g) => {
    ...
    return /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsx2("h3", { className: "text-sm font-black mb-2 px-1", style: { color: "#16222E" }, children: g.label }),
      /* @__PURE__ */ jsx2("div", { className: "flex flex-col gap-2", children: list.map((tk, i) => TaskCard(ctx, tk, false, i + 1)) })
    ] }, g.key);
  }) });
}

// components/ProblemComponents.jsx
import { Pencil as Pencil2, ChevronDown as ChevronDown2, ChevronUp as ChevronUp2, MapPin, X as X2 } from "lucide-react";

// components/ReviewBlock.jsx
import { Send as Send2, Check } from "lucide-react";
...
function ReviewBlock(ctx, item, reviewFn, ownerId) {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "mt-2 pt-2 flex flex-col gap-2", style: { borderTop: "1px solid #EEF1F4" }, children: [
    /* @__PURE__ */ jsx3("span", { className: "text-[11px] font-black px-2 py-1 rounded-full self-start", style: { background: meta.bg, color: meta.color }, children: meta[lang] || meta.ar }),
    (item.comments || []).length > 0 && /* @__PURE__ */ jsx3("div", { className: "flex flex-col gap-1.5", children: item.comments.map((c) => /* @__PURE__ */ jsxs3("div", { className: "rounded-lg px-3 py-2 text-xs", style: { background: "#F4F6F8" }, children: [
      ...
      /* @__PURE__ */ jsx3("p", { style: { color: "#5B6B79" }, children: c.text })
    ] }, c.id)) }),
    canResubmit && /* @__PURE__ */ jsx3("button", { onClick: () => runWithBusy("resubmit_" + item.id, () => {
      reviewFn(item.id, "resubmit");
      clearDraft();
    }), className: "text-xs font-bold py-2 rounded-lg", style: { background: "#1F4E79", color: "white" }, children: BtnContent2(ctx, "resubmit_" + item.id, t("resubmitBtn")) }),
    /* @__PURE__ */ jsxs3("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx3("input", { value: draft, onChange: (e) => setDraft(e.target.value), placeholder: myTurn ? t("rerouteNotePlaceholder") : t("addCommentBtn"), className: "flex-1 text-xs outline-none", style: { ...inputStyle, padding: "8px 10px" } }),
      /* @__PURE__ */ jsx3("button", { onClick: () => {
        if (draft.trim()) {
          reviewFn(item.id, "comment", draft);
          clearDraft();
        }
      }, className: "w-8 h-8 rounded-lg flex items-center justify-center shrink-0", style: { background: "#1F4E79" }, children: /* @__PURE__ */ jsx3(Send2, { size: 13, color: "white" }) })
    ] }),
    myTurn && /* @__PURE__ */ jsxs3("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx3("button", { onClick: () => runWithBusy("approve_" + item.id, () => {
        reviewFn(item.id, "approve");
        clearDraft();
      }), className: "flex-1 flex items-center justify-center gap-1.5 text-xs font-bold py-2 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: busyAction === "approve_" + item.id ? BtnContent2(ctx, "approve_" + item.id, isShiftTurn(status) ? t("approve") : t("approveFinal")) : /* @__PURE__ */ jsxs3(Fragment2, { children: [
        /* @__PURE__ */ jsx3(Check, { size: 14 }),
        " ",
        isShiftTurn(status) ? t("approve") : t("approveFinal")
      ] }) }),
      /* @__PURE__ */ jsx3("button", { onClick: () => runWithBusy("reroute_" + item.id, () => {
        reviewFn(item.id, "reroute", draft);
        clearDraft();
      }), className: "flex-1 text-xs font-bold py-2 rounded-lg", style: { background: "#C0392B", color: "white" }, children: BtnContent2(ctx, "reroute_" + item.id, t("reroute")) })
    ] })
  ] });
}
...
// components/CalendarOverlay.jsx
...
function DayModal(ctx) {
  ...
  return /* @__PURE__ */ jsx5("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4", style: { background: "rgba(22,34,46,0.45)" }, onClick: () => {
    ...
    dayModalAddOpen && TaskFormPanel(ctx)
  ] }) });
}
function CalendarOverlay(ctx) {
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "flex flex-col gap-3", style: { animation: "fadeSlideUp 240ms ease-out" }, children: [
    ...
    calSearchOpen && /* @__PURE__ */ jsx5("input", { autoFocus: true, value: calSearch, onChange: (e) => setCalSearch(e.target.value), placeholder: t("searchTaskPH"), className: "w-full text-sm outline-none", style: inputStyle }),
...
// components/StaffOverlay.jsx
import { X as X5, ArrowLeftRight } from "lucide-react";
...
function StaffOverlay(ctx) {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "flex flex-col gap-3", style: { animation: "fadeSlideUp 240ms ease-out" }, children: [
    ...
    /* @__PURE__ */ jsx7("div", { className: "flex gap-2", children: [["all", t("allStaff")], ["present", t("present")], ["leave", t("onLeave")]].map(([k, l]) => /* @__PURE__ */ jsx7("button", { onClick: () => setStaffTab(k), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: staffTab === k ? "#1F4E79" : "#FFFFFF", color: staffTab === k ? "white" : "#5B6B79", border: "1px solid " + (staffTab === k ? "#1F4E79" : "#DCE3E8") }, children: l }, k)) }),
    staffTab === "present" && /* @__PURE__ */ jsxs7("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx7("button", { onClick: () => setPresentShiftTab("day"), className: "flex-1 text-sm font-bold py-2 rounded-lg", style: { background: presentShiftTab === "day" ? "#B25E09" : "#F4F6F8", color: presentShiftTab === "day" ? "white" : "#5B6B79" }, children: t("dayShift") }),
      /* @__PURE__ */ jsx7("button", { onClick: () => setPresentShiftTab("night"), className: "flex-1 text-sm font-bold py-2 rounded-lg", style: { background: presentShiftTab === "night" ? "#1F4E79" : "#F4F6F8", color: presentShiftTab === "night" ? "white" : "#5B6B79" }, children: t("nightShift") })
    ] }),
    /* @__PURE__ */ jsxs7("div", { className: "flex flex-col gap-4", children: [
      departments.map((d) => {
        ...
        return /* @__PURE__ */ jsxs7("div", { children: [
          /* @__PURE__ */ jsxs7("h4", { className: "text-xs font-black mb-2 px-1", style: { color: deptColor(d).text }, children: [
            d,
            " (",
            list.length,
            ")"
          ...
          /* @__PURE__ */ jsx7("div", { className: "flex flex-col gap-2", children: list.map((p) => /* @__PURE__ */ jsxs7("div", { className: "rounded-xl p-3.5 flex items-center justify-between gap-3", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
            ...
            /* @__PURE__ */ jsxs7("div", { className: "flex flex-col items-end gap-1.5 shrink-0", children: [
              canManage && /* @__PURE__ */ jsxs7(Fragment4, { children: [
                /* @__PURE__ */ jsxs7("button", { onClick: () => toggleLeave(p.id), className: "flex items-center gap-1.5 text-[11px] font-bold px-3 py-1.5 rounded-lg", style: { background: "#F4F6F8", color: "#5B6B79", border: "1px solid #E2E8ED" }, children: [
                  /* @__PURE__ */ jsx7(ArrowLeftRight, { size: 12 }),
                  " ",
                  p.onLeave ? t("moveToPresent") : t("moveToLeave")
                ] }),
                !p.onLeave && /* @__PURE__ */ jsxs7("button", { onClick: () => toggleShift(p.id), className: "flex items-center gap-1.5 text-[11px] font-bold px-3 py-1.5 rounded-lg", style: { background: "#F4F6F8", color: "#5B6B79", border: "1px solid #E2E8ED" }, children: [
                  /* @__PURE__ */ jsx7(ArrowLeftRight, { size: 12 }),
                  " ",
                  p.shift === "night" ? t("moveToDayShift") : t("moveToNightShift")
                ] })
              ] }),
              !canManage && /* @__PURE__ */ jsx7("span", { className: "text-[11px] font-bold px-3 py-1.5 rounded-lg", style: { background: p.onLeave ? "#FBEEDF" : "#E4F3EA", color: p.onLeave ? "#B25E09" : "#2F7D4F" }, children: p.onLeave ? t("onLeave") : p.shift === "night" ? t("nightShift") : t("dayShift") })
            ] })
          ] }, p.id)) })
        ] }, d);
      }),
...
// components/LogbookOverlay.jsx
import { X as X6, Download } from "lucide-react";
...
function LogbookOverlay(ctx) {
  ...
  function deptContent(dept) {
    ...
    const generalSections = [
      { key: "generalTasks", list: dTasks.filter((tk) => tk.status === "completed" && tk.completedAt === today), render: (tk, i) => TaskCard(ctx, tk, false, i + 1) },
      { key: "generalProblems", list: dProblems.filter((p) => p.workStatus === "resolved" && p.dateISO === today), render: (p) => ProblemCard(ctx, p) }
    ];
  ...
  function SummaryBlock({ dept }) {
    ...
    return /* @__PURE__ */ jsxs8("div", { className: "rounded-xl p-4 flex flex-col gap-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      ...
      /* @__PURE__ */ jsxs8("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsx8("button", { onClick: () => runWithBusy("approveLogbook_" + dept, () => approveLogbook(dept)), className: "flex-1 text-xs font-bold py-2 rounded-lg", style: { background: "#2F7D4F", color: "white" }, children: BtnContent2(ctx, "approveLogbook_" + dept, t("approveLogbookBtn")) })
      ] }),
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "flex flex-col gap-3", style: { animation: "fadeSlideUp 240ms ease-out" }, children: [
    ...
    isShiftSupervisor && /* @__PURE__ */ jsxs8(Fragment5, { children: [
      /* @__PURE__ */ jsxs8("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxs8("button", { onClick: () => exportLogbook("pdf"), className: "flex-1 flex items-center justify-center gap-1.5 text-sm font-bold py-2.5 rounded-lg", style: { background: "#FFFFFF", border: "1px solid #DCE3E8", color: "#16222E" }, children: [
          /* @__PURE__ */ jsx8(Download, { size: 15 }),
          " ",
          t("exportPdf")
        ] }),
    ...
    !isShiftSupervisor && canManage && (ownApproved ? /* @__PURE__ */ jsxs8(Fragment5, { children: [
      /* @__PURE__ */ jsxs8("div", { className: "rounded-xl p-4", style: { background: "#E4F3EA" }, children: [
        /* @__PURE__ */ jsx8("p", { className: "text-sm font-bold mb-1", style: { color: "#2F7D4F" }, children: t("logbookSummaryLbl") }),
        /* @__PURE__ */ jsx8("p", { className: "text-sm", style: { color: "#16222E" }, children: ownEntry.summary }),
      ...
      /* @__PURE__ */ jsx8(Content, { dept: viewer.department })
    ...
    !canManage && /* @__PURE__ */ jsx8(Content, { dept: viewer.department })
  ] });
}

// components/ReadingsOverlay.jsx
import { Plus as Plus2, ChevronUp as ChevronUp3, X as X7, Activity as Activity2, FileText as FileText2, Download as Download2 } from "lucide-react";
...
function ReadingsOverlay(ctx) {
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "flex flex-col gap-3", style: { animation: "fadeSlideUp 240ms ease-out" }, children: [
    ...
    canSubmitReading && /* @__PURE__ */ jsxs9("div", { className: "rounded-xl p-4 flex flex-col gap-3", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      ...
      !readingAttachment ? /* @__PURE__ */ jsxs9("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxs9("label", { className: "flex-1 flex items-center justify-center gap-1.5 text-sm font-bold py-3 rounded-lg cursor-pointer", style: { background: "#F4F6F8", color: "#16222E", border: "1px dashed #DCE3E8" }, children: [
          /* @__PURE__ */ jsx9(Download2, { size: 16, style: { transform: "rotate(180deg)" } }),
          " ",
          t("attachReadingFile"),
          /* @__PURE__ */ jsx9("input", { type: "file", accept: "image/*,.pdf", className: "hidden", onChange: handleReadingFile })
        ] }),
        /* @__PURE__ */ jsxs9("label", { className: "flex-1 flex items-center justify-center gap-1.5 text-sm font-bold py-3 rounded-lg cursor-pointer", style: { background: "#F4F6F8", color: "#16222E", border: "1px dashed #DCE3E8" }, children: [
          /* @__PURE__ */ jsx9(Activity2, { size: 16 }),
          " ",
          t("takePhoto"),
        ...
        readingAttachment.isImage ? /* @__PURE__ */ jsx9("img", { src: readingAttachment.dataUrl, alt: "", className: "w-14 h-14 rounded-lg object-cover shrink-0" }) : /* @__PURE__ */ jsx9("div", { className: "w-14 h-14 rounded-lg flex items-center justify-center shrink-0", style: { background: "#E6EEF5" }, children: /* @__PURE__ */ jsx9(FileText2, { size: 22, color: "#1F4E79" }) }),
    ...
    /* @__PURE__ */ jsxs9("div", { className: "flex items-center justify-between rounded-xl p-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      ...
      /* @__PURE__ */ jsx9("p", { className: "text-sm font-black", style: { color: "#16222E" }, children: readingsViewDate === today ? t("todayLbl") : readingsViewDate }),
      /* @__PURE__ */ jsx9("button", { onClick: () => setReadingsViewDate((d) => shiftISODate(d, 1)), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx9(ChevronUp3, { size: 16, style: { transform: "rotate(90deg)" }, color: "#16222E" }) })
    ] }),
    /* @__PURE__ */ jsxs9("div", { children: [
      /* @__PURE__ */ jsx9("p", { className: "text-xs font-bold mb-2 px-1", style: labelStyle, children: t("previousReadings") }),
      /* @__PURE__ */ jsxs9("div", { className: "flex flex-col gap-2.5", children: [
        deptReadings.length === 0 && /* @__PURE__ */ jsx9("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: t("noReadingsYet") }),
        deptReadings.map((r) => /* @__PURE__ */ jsxs9("div", { className: "rounded-xl p-3.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
          ...
          r.attachment && /* @__PURE__ */ jsxs9("div", { className: "flex items-center gap-2 mb-2", children: [
            r.attachment.isImage ? /* @__PURE__ */ jsx9("img", { src: r.attachment.dataUrl, alt: "", className: "w-12 h-12 rounded-lg object-cover" }) : /* @__PURE__ */ jsx9("div", { className: "w-12 h-12 rounded-lg flex items-center justify-center", style: { background: "#E6EEF5" }, children: /* @__PURE__ */ jsx9(FileText2, { size: 18, color: "#1F4E79" }) }),
...
// components/ReportsOverlay.jsx
import { ChevronUp as ChevronUp4, X as X8, FileText as FileText3, Download as Download3 } from "lucide-react";
...
function ReportsOverlay(ctx) {
  ...
  function UploadCard(onSaveKind, canSubmit, restrictionNote) {
    ...
    return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-3", style: { animation: "fadeSlideUp 240ms ease-out" }, children: [
      !reportAttachment ? /* @__PURE__ */ jsxs10("label", { className: "flex items-center justify-center gap-1.5 text-sm font-bold py-3 rounded-lg cursor-pointer", style: { background: "#F4F6F8", color: "#16222E", border: "1px dashed #DCE3E8" }, children: [
        /* @__PURE__ */ jsx10(Download3, { size: 16, style: { transform: "rotate(180deg)" } }),
        " ",
        t("attachReportFile"),
        ...
        reportAttachment.isImage ? /* @__PURE__ */ jsx10("img", { src: reportAttachment.dataUrl, alt: "", className: "w-14 h-14 rounded-lg object-cover shrink-0" }) : /* @__PURE__ */ jsx10("div", { className: "w-14 h-14 rounded-lg flex items-center justify-center shrink-0", style: { background: "#E6EEF5" }, children: /* @__PURE__ */ jsx10(FileText3, { size: 22, color: "#1F4E79" }) }),
      ...
      /* @__PURE__ */ jsx10("button", { onClick: () => runWithBusy("saveReport", onSaveKind), disabled: !reportAttachment, className: "text-sm font-bold py-2.5 rounded-lg", style: { background: "#1F4E79", color: "white", opacity: !reportAttachment ? 0.5 : 1 }, children: BtnContent2(ctx, "saveReport", t("saveReadingBtn")) })
    ] });
  }
  return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-3", children: [
    ...
    reportsTab === "daily" && /* @__PURE__ */ jsxs10(Fragment6, { children: [
      ...
      /* @__PURE__ */ jsxs10("div", { className: "rounded-xl p-3.5 flex items-center gap-3", style: { background: "#F4F6F8", border: "1px dashed #DCE3E8" }, children: [
        /* @__PURE__ */ jsx10(FileText3, { size: 20, color: "#8A97A3" }),
      ...
      /* @__PURE__ */ jsxs10("div", { className: "flex items-center justify-between rounded-xl p-2.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
        ...
        /* @__PURE__ */ jsx10("p", { className: "text-sm font-black", style: { color: "#16222E" }, children: reportsViewDate === today ? t("todayLbl") : reportsViewDate }),
        /* @__PURE__ */ jsx10("button", { onClick: () => setReportsViewDate((d) => shiftISODate(d, 1)), className: "w-9 h-9 rounded-lg flex items-center justify-center", style: { background: "#F4F6F8" }, children: /* @__PURE__ */ jsx10(ChevronUp4, { size: 16, style: { transform: "rotate(90deg)" }, color: "#16222E" }) })
      ] }),
      /* @__PURE__ */ jsxs10("div", { children: [
        /* @__PURE__ */ jsx10("p", { className: "text-xs font-bold mb-2 px-1", style: labelStyle, children: t("previousReports") }),
        /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-2.5", children: [
          ...
          dayReports.map((r) => /* @__PURE__ */ jsxs10("div", { className: "rounded-xl p-3.5", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
            /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-3", children: [
              r.attachment.isImage ? /* @__PURE__ */ jsx10("img", { src: r.attachment.dataUrl, alt: "", className: "w-12 h-12 rounded-lg object-cover shrink-0" }) : /* @__PURE__ */ jsx10("div", { className: "w-12 h-12 rounded-lg flex items-center justify-center shrink-0", style: { background: "#E6EEF5" }, children: /* @__PURE__ */ jsx10(FileText3, { size: 18, color: "#1F4E79" }) }),
    ...
    reportsTab === "periodic" && /* @__PURE__ */ jsxs10(Fragment6, { children: [
...
import { Trash2 as Trash22, UserPlus, ShieldCheck, X as X10, Menu } from "lucide-react";
  ...
  return /* @__PURE__ */ jsxs13("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsxs13("div", { className: "rounded-xl p-4", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
      /* @__PURE__ */ jsxs13("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsx13(ShieldCheck, { size: 16, color: "#1F4E79" }),
...
function TaskManager() {
  ...
  return /* @__PURE__ */ jsxs14("div", { dir: lang === "en" ? "ltr" : "rtl", className: "min-h-screen w-full", style: { background: "#EEF1F4", fontFamily: lang === "en" ? "system-ui, sans-serif" : "'Tajawal', sans-serif" }, children: [
    /* @__PURE__ */ jsx14("style", { children: `
      ...
      ` }),
    ToastStack(ctx),
    /* @__PURE__ */ jsxs14("div", { className: "max-w-3xl mx-auto px-4 py-6", children: [
      /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-2.5 mb-4 flex items-center gap-2", style: { background: "#FFF6EB", border: "1px solid #F0C57A" }, children: [
        /* @__PURE__ */ jsx14("span", { className: "text-xs font-bold", style: { color: "#5B4321" }, children: t("previewAs") }),
        /* @__PURE__ */ jsx14("select", { value: currentUserId, onChange: (e) => setCurrentUserId(Number(e.target.value)), className: "text-xs outline-none flex-1", style: { ...inputStyle, padding: "6px 10px" }, children: people.map((p) => /* @__PURE__ */ jsxs14("option", { value: p.id, children: [
          p.name,
          " (",
          p.employeeId,
          ") \u2014 ",
        ...
        /* @__PURE__ */ jsxs14("button", { onClick: () => setLang(lang === "ar" ? "en" : "ar"), className: "flex items-center gap-1 text-xs font-bold px-2.5 py-1.5 rounded-lg shrink-0", style: { background: "#FFFFFF", border: "1px solid #F0C57A", color: "#5B4321" }, children: [
          /* @__PURE__ */ jsx14(Languages2, { size: 13 }),
          " ",
          lang === "ar" ? "EN" : "AR"
        ] })
      ] }),
      viewerRole === "admin" ? /* @__PURE__ */ jsxs14(Fragment7, { children: [
        /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-3 mb-5", children: [
          Avatar(ctx, viewer.department, 48),
          /* @__PURE__ */ jsxs14("div", { children: [
            /* @__PURE__ */ jsx14("p", { className: "text-base font-black", style: { color: "#16222E" }, children: viewer.name }),
            /* @__PURE__ */ jsx14("p", { className: "text-[11px]", style: { color: "#8A97A3" }, children: viewer.employeeId }),
            /* @__PURE__ */ jsx14("p", { className: "text-xs", style: labelStyle, children: t("appAdmin") })
          ] })
        ] }),
        AdminView(ctx)
        ...
        /* @__PURE__ */ jsxs14("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxs14("div", { children: [
              /* @__PURE__ */ jsx14("p", { className: "text-base font-black", style: { color: "#16222E" }, children: viewer.name }),
              /* @__PURE__ */ jsx14("p", { className: "text-[11px]", style: { color: "#8A97A3" }, children: viewer.employeeId }),
              /* @__PURE__ */ jsx14("p", { className: "text-xs", style: labelStyle, children: viewer.role })
            ] })
          ] }),
          /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxs14("div", { className: "relative", ref: notifRef, children: [
              /* @__PURE__ */ jsxs14("button", { onClick: () => setNotifOpen((o) => !o), className: "w-12 h-12 rounded-full flex items-center justify-center relative", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
                /* @__PURE__ */ jsx14(Bell, { size: 22, color: "#16222E" }),
                notifications.length > 0 && /* @__PURE__ */ jsx14("span", { className: "absolute -top-1 -left-1 text-[10px] font-bold rounded-full flex items-center justify-center", style: { width: 18, height: 18, background: "#C0392B", color: "white" }, children: notifications.length })
              ] }),
              notifOpen && /* @__PURE__ */ jsxs14("div", { className: "absolute left-0 mt-2 w-72 rounded-xl p-2 z-10 flex flex-col gap-1", style: { background: "#FFFFFF", border: "1px solid #DCE3E8", boxShadow: "0 8px 24px rgba(0,0,0,0.08)" }, children: [
                notifications.length === 0 && /* @__PURE__ */ jsx14("p", { className: "text-xs text-center py-4", style: { color: "#8A97A3" }, children: t("noNotifications") }),
                notifications.map((n, i) => /* @__PURE__ */ jsxs14("div", { className: "text-xs px-3 py-2 rounded-lg", style: { background: "#F4F6F8" }, children: [
                  /* @__PURE__ */ jsxs14("span", { className: "font-bold ml-1", style: { color: "#1F4E79" }, children: [
                    "[",
                    n.kind,
                    "]"
                  ] }),
                  /* @__PURE__ */ jsx14("span", { style: { color: "#16222E" }, children: n.text })
                ] }, i))
              ] })
            ] }),
            hasDrawer && /* @__PURE__ */ jsx14("button", { onClick: () => setDrawerOpen(true), className: "w-11 h-11 rounded-full flex items-center justify-center", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx14(Menu2, { size: 19, color: "#16222E" }) })
          ] })
        ] }),
        DrawerMenu(ctx),
        ...
        !activeOverlay && /* @__PURE__ */ jsxs14(Fragment7, { children: [
          /* @__PURE__ */ jsxs14("div", { className: "flex gap-2 mb-3", children: [
            !isCoordinator && /* @__PURE__ */ jsx14("button", { onClick: () => setMainSubTab("tasks"), className: "flex-1 text-base font-black py-3 rounded-xl", style: { background: mainSubTab === "tasks" ? "#1F4E79" : "#FFFFFF", color: mainSubTab === "tasks" ? "white" : "#5B6B79", border: "1px solid " + (mainSubTab === "tasks" ? "#1F4E79" : "#DCE3E8") }, children: t("tasks") }),
            /* @__PURE__ */ jsxs14("button", { onClick: () => setMainSubTab("problems"), className: "flex-1 text-base font-black py-3 rounded-xl", style: { background: mainSubTab === "problems" ? "#1F4E79" : "#FFFFFF", color: mainSubTab === "problems" ? "white" : "#5B6B79", border: "1px solid " + (mainSubTab === "problems" ? "#1F4E79" : "#DCE3E8") }, children: [
              t("problems"),
              " ",
          ...
          isAdvisory && /* @__PURE__ */ jsx14("p", { className: "text-xs mb-3 px-1", style: { color: "#B25E09" }, children: t("advisoryNote") }),
          isCoordinator && /* @__PURE__ */ jsx14("p", { className: "text-xs mb-3 px-1", style: { color: "#B25E09" }, children: t("coordinatorNote") }),
          mainSubTab === "tasks" && viewerRole === "supervisor" && /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsx14("button", { onClick: () => setSupTasksTab("list"), className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", title: t("todayTaskList"), style: { background: supTasksTab === "list" ? "#1F4E79" : "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx14(List, { size: 19, color: supTasksTab === "list" ? "white" : "#16222E" }) }),
            canManage && /* @__PURE__ */ jsx14("button", { onClick: () => {
              setTaskForm(emptyTaskForm());
              setEditingId(null);
              setShowTaskForm(true);
            }, className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", style: { background: "#1F4E79" }, children: /* @__PURE__ */ jsx14(Plus3, { size: 20, color: "white" }) }),
            /* @__PURE__ */ jsx14("button", { onClick: () => setSupTasksTab((s) => s === "inprogress" ? "list" : "inprogress"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: supTasksTab === "inprogress" ? "#1F4E79" : "#FFFFFF", color: supTasksTab === "inprogress" ? "white" : "#5B6B79", border: "1px solid " + (supTasksTab === "inprogress" ? "#1F4E79" : "#DCE3E8") }, children: t("inProgressBtn") }),
            /* @__PURE__ */ jsx14("button", { onClick: () => setSupTasksTab((s) => s === "completed" ? "list" : "completed"), className: "flex-1 text-sm font-bold py-2.5 rounded-lg", style: { background: supTasksTab === "completed" ? "#1F4E79" : "#FFFFFF", color: supTasksTab === "completed" ? "white" : "#5B6B79", border: "1px solid " + (supTasksTab === "completed" ? "#1F4E79" : "#DCE3E8") }, children: t("completedBtn") })
          ] }),
          mainSubTab === "problems" && /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2 mb-2", children: [
            /* @__PURE__ */ jsx14("button", { onClick: () => setProblemView("status"), className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", title: t("problemsList"), style: { background: problemView === "status" ? "#1F4E79" : "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx14(List, { size: 19, color: problemView === "status" ? "white" : "#16222E" }) }),
            (viewerRole === "operator" || canManage) && /* @__PURE__ */ jsx14("button", { onClick: () => {
              setShowProblemForm(true);
            }, className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", style: { background: "#1F4E79" }, children: /* @__PURE__ */ jsx14(Plus3, { size: 20, color: "white" }) }),
            /* @__PURE__ */ jsx14("button", { onClick: () => setProblemSearchOpen((o) => !o), className: "w-11 h-11 rounded-lg flex items-center justify-center shrink-0", style: { background: problemSearchOpen ? "#1F4E79" : "#FFFFFF", border: "1px solid #DCE3E8" }, children: /* @__PURE__ */ jsx14(Search3, { size: 18, color: problemSearchOpen ? "white" : "#16222E" }) }),
            !isCoordinator && /* @__PURE__ */ jsxs14("button", { onClick: () => setProblemView((s) => s === "log" ? "status" : "log"), className: "flex-1 flex items-center justify-center gap-1.5 text-sm font-bold py-2.5 rounded-lg", style: { background: problemView === "log" ? "#1F4E79" : "#FFFFFF", color: problemView === "log" ? "white" : "#5B6B79", border: "1px solid " + (problemView === "log" ? "#1F4E79" : "#DCE3E8") }, children: [
              /* @__PURE__ */ jsx14(Clock, { size: 15 }),
              " ",
              t("fullLog")
            ] })
          ] }),
          mainSubTab === "problems" && problemSearchOpen && /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-3 mb-4 flex flex-col gap-2", style: { background: "#FFFFFF", border: "1px solid #DCE3E8" }, children: [
            /* @__PURE__ */ jsx14("input", { autoFocus: true, value: problemSearch, onChange: (e) => setProblemSearch(e.target.value), placeholder: t("searchPlaceholder"), className: "w-full text-sm outline-none", style: inputStyle }),
            /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsx14("span", { className: "text-[11px] font-bold", style: { color: "#8A97A3" }, children: t("searchField") }),
              [["all", t("all")], ["tagNumber", t("fieldTag")], ["equipmentName", t("fieldEquip")], ["department", t("fieldDept")], ["location", t("fieldLoc")]].map(([k, l]) => /* @__PURE__ */ jsx14("button", { onClick: () => setProblemSearchField(k), className: "text-[11px] font-bold px-2.5 py-1 rounded-full", style: { background: problemSearchField === k ? "#1F4E79" : "#F4F6F8", color: problemSearchField === k ? "white" : "#5B6B79" }, children: l }, k))
            ] })
          ] }),
          mainSubTab === "tasks" && showTaskForm && canManage && TaskFormPanel2(ctx),
          mainSubTab === "problems" && showProblemForm && ProblemFormPanel(ctx),
          mainSubTab === "tasks" && /* @__PURE__ */ jsxs14(Fragment7, { children: [
            AlertsBlock(ctx),
            viewerRole === "operator" ? /* @__PURE__ */ jsxs14("div", { className: "flex flex-col gap-2.5", children: [
              deptTasks.length === 0 && /* @__PURE__ */ jsxs14("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: [
                t("noTasks"),
                "."
              ] }),
          ...
          mainSubTab === "problems" && problemView === "status" && /* @__PURE__ */ jsxs14("div", { className: "flex flex-col gap-5", children: [
            Object.entries(WORK_STATUS).map(([k, v]) => {
              ...
              return /* @__PURE__ */ jsxs14("div", { children: [
                /* @__PURE__ */ jsx14("h4", { className: "text-sm font-black mb-2 px-1", style: { color: v.color }, children: v[lang] || v.ar }),
                /* @__PURE__ */ jsx14("div", { className: "flex flex-col gap-2.5", children: list.map((p) => ProblemCard(ctx, p, { withApprove: true })) })
              ] }, k);
            }),
            problemsVisibleToViewer.filter(matchesProblemSearch).length === 0 && /* @__PURE__ */ jsx14("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: t("noProblems") })
          ] }),
          mainSubTab === "problems" && problemView === "log" && /* @__PURE__ */ jsxs14("div", { className: "flex flex-col gap-2.5", children: [
            problemsChrono.filter(matchesProblemSearch).length === 0 && /* @__PURE__ */ jsx14("div", { className: "rounded-xl p-8 text-center text-sm", style: { background: "#FFFFFF", border: "1px dashed #DCE3E8", color: "#8A97A3" }, children: t("noProblems") }),
